        ...
        if len(sys.argv) >1:
            for arg in sys.argv[1:]:
                if arg.lower().startswith("appendclass="):
                    ...
                    errString = "xsCreateADContext-F-003: Invalid argument: " + arg
                    raise Exception(errString) 
        else:
            raise Exception("xsCreateADContext-F-001: Usage: xsCreateADContext name=<string> terms=<conceptlist-option> (type=<contexttype-option>)? (<fuzzyvalues-option>)*")
