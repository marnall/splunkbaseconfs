...
if __name__ == '__main__':
    ...
    try:
        if len(sys.argv) >1:
                                ...
                                if fromKeyword == '':
                                    if withKeyword == '':
                                        ...
                                        if arg.lower().startswith("points="):
                                            ...
                                            errString = "xsvCreateConcept-F-003: Invalid argument: " + arg
            ...
            raise Exception("xsvCreateConcept-F-001: Usage: xsvCreateConcept concept[,concept]* FROM context [IN container] [BY class] [SCOPED scope] [APP app] WITH points='double[,double]+\' [shape='shapeStr'] [; points='double[,double]+' [shape='shapeStr'] ]*")

        if points == '':
            raise Exception("xsvCreateConcept-F-007: parameter 'points' not found")
        ...
        saUtils.runProcess(sys.argv[0], "xsvCreateConcept", argList, True)
