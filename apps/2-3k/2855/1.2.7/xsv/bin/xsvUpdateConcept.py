...
if __name__ == '__main__':
    ...
    try:
        if len(sys.argv) >1:
            ...
            raise Exception("xsvUpdateConcept-F-001: Usage: xsvUpdateConcept concept[,concept]* FROM context [IN container] [BY class] [SCOPED scope] [APP app] WITH points='double[,double]+\' [shape='shapeStr'] [; points='double[,double]+' [shape='shapeStr'] ]*")
