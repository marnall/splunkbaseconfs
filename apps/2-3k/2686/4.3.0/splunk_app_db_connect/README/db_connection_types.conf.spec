...
description = <string>
# Optional
# Helps inform the customer about the specific characteristics of the selected connection type. It supports Markdown formatting.

vector_search = <bool>
# Optional
# Whether the connection type supports vector search.

vector_search_query = <string>
# Optional
# The query to be used for vector search.
