...
"""
atomicfile.py - atomically replace files

License: MIT
Source: https://github.com/sashka/atomicfile
Version: 62683e2e0cb8b0c04981d5fe50d272b539095a59
"""
...
def _maketemp(name, createmode=None):
    ...
    tempf = tempfile.NamedTemporaryFile(prefix=".%s-" % fn, dir=d, delete=False)
    tempname = tempf.name
    try:
