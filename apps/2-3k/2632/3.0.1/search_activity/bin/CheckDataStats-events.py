...
searchquery_normal = '| rest splunk_server=local "/servicesNS/admin/-/search/jobs"| search dispatchState="RUNNING" OR dispatchState="FINALIZING" OR dispatchState="QUEUED" OR dispatchState="PARSING" title!="| rest*" title="*FillEvents*" '
...
searchquery_normal = '| rest splunk_server=local "/servicesNS/admin/search_activity/properties/macros/backfill_events_window/definition"'
job = service.jobs.create(searchquery_normal, **kwargs_normalsearch)
...
searchquery_normal = '| rest splunk_server=local "/servicesNS/admin/search_activity/properties/macros/backfill_events_internal/definition"'
job = service.jobs.create(searchquery_normal, **kwargs_normalsearch)
