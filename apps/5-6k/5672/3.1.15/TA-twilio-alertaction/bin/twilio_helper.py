...
ADDON_NAME = "TA-twilio-alertaction"
...
def get_account_api_key(session_key: str, account_name: str):
    cfm = conf_manager.ConfManager(
        session_key,
        ADDON_NAME,
        realm=f"__REST_CREDENTIAL__#{ADDON_NAME}#configs/conf-ta_twilio_alertaction_account",
    )
    account_conf_file = cfm.get_conf("ta_twilio_alertaction_account")
    ...
    for input_name, input_item in inputs.inputs.items():
        ...
        try:
            ...
            log_level = conf_manager.get_log_level(
                ...
                app_name=ADDON_NAME,
                conf_name="ta_twilio_alertaction_settings",
            )
