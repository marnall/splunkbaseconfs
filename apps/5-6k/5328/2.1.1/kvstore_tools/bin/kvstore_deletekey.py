"""
KV Store Collection Single Record Deleter search command
...
class KVStoreDeleteKeyCommand(GeneratingCommand):
	...
	def generate(self):
		...
		collection_list = kv.get_app_collections(splunkd_uri, auth_header, self.collection, self.app, app_list, True)
