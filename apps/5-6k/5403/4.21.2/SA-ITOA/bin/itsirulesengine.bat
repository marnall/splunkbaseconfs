@REM sa-itsi-rule-engine launcher script
@REM
@REM Environment:
...
set "APP_CLASSPATH=%APP_LIB_DIR%\java\event_management\libs\*;%APP_LIB_DIR%\java\event_management\rules_engine\*"

set "APP_MAIN_CLASS=com.splunk.itsi.search.chunk.RulesEngineSearch"
