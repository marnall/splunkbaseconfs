...
class THEHIVE_AUDIT(smi.Script):
    def __init__(self):
        super(THEHIVE_AUDIT, self).__init__()

    def get_scheme(self):
        scheme = smi.Scheme('thehive_audit')
        scheme.description = 'TheHive: Audit'
    ...
    def stream_events(self, inputs, ew):
        ...
        custom_logger = setup_logging("thehive_audit")
