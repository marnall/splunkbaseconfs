...
class Encryptor:
    ...
    def encrypt_token(self, name: str, token: str, session_key: str):
        """This method calls to the storage passwords interface and encrypts the audit trails token

        Args:
            name: name of the input stanza (terraform_cloud://something)
            token: audit trails token
    ...
    def mask_token(self, name: str, api_url: str, session_key: str):
        """This method calls to the inputs interface and masks the audit trails token
