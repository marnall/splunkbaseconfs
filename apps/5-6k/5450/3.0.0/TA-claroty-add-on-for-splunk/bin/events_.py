...
import input_module_events_ as input_module

bin_dir = os.path.dirname(os.path.abspath(__file__))


class ModInputEvents(base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super().__init__("ta_claroty_add_on_for_splunk", "events_", use_single_instance)
    ...
    def get_scheme(self):
        ...
        scheme.add_argument(smi.Argument("sites", title="Sites",
                                         ...
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("event_type", title="Event Type",
                                         required_on_create=False,
                                         required_on_edit=False))
...
if __name__ == "__main__":
    exitcode = ModInputEvents().run(sys.argv)
    sys.exit(exitcode)
