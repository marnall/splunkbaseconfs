...
import input_module_baselines_ as input_module

bin_dir = os.path.dirname(os.path.abspath(__file__))


class ModInputBaselines(base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super().__init__("ta_claroty_add_on_for_splunk", "baselines_", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        scheme = super().get_scheme()
        scheme.title = "Baselines"
        ...
        scheme.add_argument(smi.Argument("sites", title="Sites",
                                         ...
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("baseline_category", title="Category",
                                         required_on_create=False,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("baseline_protocol", title="Protocol",
                                         required_on_create=False,
                                         required_on_edit=False))
...
if __name__ == "__main__":
    exitcode = ModInputBaselines().run(sys.argv)
    sys.exit(exitcode)
