...
import input_module_alerts_ as input_module

bin_dir = os.path.dirname(os.path.abspath(__file__))


class ModInputAlerts(base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super().__init__("ta_claroty_add_on_for_splunk", "alerts_", use_single_instance)
    ...
    def get_scheme(self):
        ...
        scheme.add_argument(smi.Argument("alert_type", title="Alert Type",
                                         required_on_create=False,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("alert_category", title="Category",
                                         required_on_create=False,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("alert_severity", title="Severity",
                                         required_on_create=False,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("alert_status", title="Status",
                                         required_on_create=False,
                                         required_on_edit=False))
...
if __name__ == "__main__":
    exitcode = ModInputAlerts().run(sys.argv)
    sys.exit(exitcode)
