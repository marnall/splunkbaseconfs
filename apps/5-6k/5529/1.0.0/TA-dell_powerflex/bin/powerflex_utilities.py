...
SETTING_CONF_FILE = 'ta_dell_powerflex_settings'
PROXY_STANZA = 'proxy'
LOGGING_STANZA = 'logging'
POWERFLEX_ADDITIONAL_PARAMETERS = 'powerflex_additional_parameters'
POWERFLEX_ENDPOINTS = 'powerflex_endpoints'
SYSTEMS_CONF_FILE = 'ta_dell_powerflex_systems'
...
def get_additional_parameters(session_key):
    ...
    :param session_key: Splunk session key
    """
    additional_info = read_conf_file(session_key, SETTING_CONF_FILE, POWERFLEX_ADDITIONAL_PARAMETERS)
...
def create_powerflex_input(system_name, stanzas, session_key, logger):
    ...
    for stanza_name in list(stanzas.keys()):
        ...
        modular_input_type = "powerflex_os_instance"
        if input_type == "statistics":
            modular_input_type = "powerflex_os_statistics"
