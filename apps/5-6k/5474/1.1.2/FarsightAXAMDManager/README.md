...
- About the Farsight AXAMD App For Splunk
- Release notes
...
- Key concepts
- Data types
- Configure Farsight AXAMD For Splunk
- Troubleshooting
- Phantom Escalation
...
| --- | --- |
| App Version | 1.0 |
| Vendor Products | Farsight AXAMD |
| Has index-time operations | false |
| Create an index | false |
| Implements summarization | false |

The Farsight AXAMD App For Splunk allows a Splunk® Enterprise administrator to index data from Farsight SRA channels and RAD modules. These can be used for various purposes such as monitoring for DNS changes or brand infringement.
...
This is the initial release of The Farsight AXAMD App For Splunk.

##### About this release

Version <1.0> of the Farsight AXAMD App For Splunk is compatible with:

| Splunk Enterprise versions | 1.0 |
| --- | --- |
| CIM | N/A |
| Platforms | Platform independent |
| Vendor Products | AXAMD |
| Lookup file changes | None |

##### Third-party software attributions

Version 1.0 of the Farsight AXAMD For Splunk incorporates the following third-party software or libraries.
...
Access questions and answers specific to the Farsight AXAMD App For Splunk on Splunkbase.
...
Farsight AXAMD For Splunk supports the following server platforms in the versions supported by Splunk Enterprise:
...
### Phantom Escalation
This app comes with searches for escalating both RAD matches and SRA watch hits.In order to make use of these, first ensure that the [Phantom App for Splunk](https://splunkbase.splunk.com/app/3411/) is installed and configured. This app includes an alert action called "Send to Phantom". Browse to the "searches, reports, and alerts" page and find the "AXAMD RAD Matches - Phantom Escalation" and "AXAMD SRA Watch Hits - Phantom Escalation" searches. Click "Edit alert" and add the Send to Phantom action. Configure the action the way you'd like your Phantom containers to be created, and then enable the alert. If your search head can't connect directly to your phantom instance, you'll need to set up adaptive response relay. Documentation on that is [here.](https://docs.splunk.com/Documentation/PhantomApp/4.0.35/Install/ConfigureARRelay)

### Splunk Cloud
Splunk cloud requires all apps to force Python to run in the Python 3 interpreter. In order to install this app to Splunk cloud, do the following.

1. Add a python.version=python3 line to both the [sra://<name>] stanza and [rad://<name>] stanza in README/inputs.conf.spec.
2. Add a python.version=python3 line to the [admin_external:axamd_settings] stanza in restmap.conf.


### Troubleshoot Farsight AXAMD For Splunk
