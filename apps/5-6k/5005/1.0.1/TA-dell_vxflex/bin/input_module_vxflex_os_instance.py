...
import json
from input_module_vxflex_common import VxFlexCommonDataCollector
from input_module_vxflex_common import timer

class VxFlexInstanceCollector(VxFlexCommonDataCollector):
    # Input type
    ...
    def __init__(self, helper, event_writer):
        ...
        :param helper: instance of ModInputvxflex_os_instance
        :param event_writer: class instance to write the events
        """
        super(VxFlexInstanceCollector, self).__init__(helper, event_writer, 'ta_dell_vxflex_vxflex_os_instance')
        ...
        self.input_ckpt_key = "{}_{}".format(self.vxflex_account_obj.name, self.input_name)
    ...
    def collect_events(self):
        """
        Collect & Ingest Dell VxFlex Instance events into Splunk
        """
        try:
    ...
    def request(self, state):
        """
        Request to the Dell Vxflex Rest endpoint
        """
