...
class VxFlexStatisticsCollector(VxFlexCommonDataCollector):
    """
    Statistics collector
    """
    def __init__(self, helper, event_writer):
        super(VxFlexStatisticsCollector, self).__init__(helper, event_writer, 'ta_dell_vxflex_vxflex_os_statistics')
