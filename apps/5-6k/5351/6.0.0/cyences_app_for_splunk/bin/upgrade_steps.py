...
def upgrade_6_0_0(session_key, logger):
    service = client.connect(token=session_key, app=cs_utils.APP_NAME)
    conf_manager = cs_utils.ConfigHandler(logger, session_key)

    # Migrate notable event lookup data to index as per the new design.
    NOTABLE_EVENT_LOOKUP_MIGRATE_SEARCH = """| inputlookup cyences_notable_event | eval _time = update_time | eval comment = coalesce(comment, "-") | makejson  assignee comment notable_event_id status update_time user_making_change  output=_raw | collect index="cyences" sourcetype="cyences:notable:tracker" source="notable_lookup_migration" addtime=false"""
    logger.info("Migrating notable event lookup data to index.")
    response = service.jobs.oneshot(NOTABLE_EVENT_LOOKUP_MIGRATE_SEARCH, output_mode="json", earliest_time='-1m', latest_time='now')
    handle_results(response, logger)

    # New alerts are added
    alert_and_filter_macro_changes = [
        {
            "new_alert_name": "CrowdStrike - Incident is Reported"
        },
        {
            "new_alert_name": "CrowdStrike - Identity Anomalies Detected"
        },
        {
            "new_alert_name": "CrowdStrike - DLP Violations Detected"
        },
        {
            "new_alert_name": "Linux - Multiple Failed SSH Logins"
        },
        {
            "new_alert_name": "Linux - Possible Access to Credential Files"
        },
        {
            "new_alert_name": "Linux - Root Filesystem Deletion Attempt"
        },
        {
            "new_alert_name": "Linux - System Request (SysRq) Abuse Detected"
        },
        {
            "new_alert_name": "Linux - Outbound Connections to High-Risk Ports"
        },
        {
            "new_alert_name": "Windows - Multiple Host Login Failures by User"
        },
        {
            "new_alert_name": "Windows - Logins to multiple systems from the same IP"
        },
        {
            "new_alert_name": "Windows - Logon using built-in Administrator accounts"
        },
        {
            "new_alert_name": "Windows - PowerShell Encoded Command Detected"
        },
        {
            "new_alert_name": "Windows - Scheduled Task Started or Deleted"
        },
        {
            "new_alert_name": "Windows - RDP Login Attempts Outside Working Hours"
        },
        {
            "new_alert_name": "Azure AD - User Account Self-Unlock"
        },
        {
            "new_alert_name": "O365 - Malicious File Detected in SharePoint"
        },
        {
            "new_alert_name": "O365 - Suspicious Email Detected"
        },
        {
            "new_alert_name": "O365 - Spoofing Attempts Detected"
        },
        {
            "new_alert_name": "O365 - Multiple Password Reset Attempts"
        },
        {
            "new_alert_name": "O365 - Successful Login After Multiple Failed Attempts"
        },
        {
            "new_alert_name": "O365 - Defender XDR Detection"
        },
        {
            "new_alert_name": "O365 - Risky User Detected"
        },
        {
            "new_alert_name": "Authentication - Multiple Failed Logins by User"
        },
        {
            "new_alert_name": "Delinea PAM - Multiple Failed Logins by User"
        },
        {
            "new_alert_name": "Delinea PAM - Multiple Secret Edit Activity by User"
        },
        {
            "new_alert_name": "Delinea PAM - Login outside Working Hours"
        },
        {
            "new_alert_name": "Delinea PAM - Spike in Secret Retrieval"
        },
        {
            "new_alert_name": "Delinea PAM - Manual Password Reveal"
        },
        {
            "new_alert_name": "Delinea PAM - Secret Permission is Edited"
        },
        {
            "old_alert_name": "Trendmicro - Ransomware Bahavior Detected",
            "new_alert_name": "Trendmicro - Ransomware Behavior Detected",
        },
        {
            "old_alert_name": "Trendmicro - Critical Observered Attack Technique Detected",
            "new_alert_name": "Trendmicro - Critical Observed Attack Technique Detected",
        },
