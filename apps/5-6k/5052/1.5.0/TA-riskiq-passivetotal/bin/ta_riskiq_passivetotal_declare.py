...
ta_name = 'TA-riskiq-passivetotal'
ta_lib_name = 'ta_riskiq_passivetotal'
...
# Keep custom libs at priority
new_paths.insert(0, os.path.sep.join([os.path.dirname(__file__), 'libs']))
