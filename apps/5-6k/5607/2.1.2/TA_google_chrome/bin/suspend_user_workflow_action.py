...
@Configuration()
class suspenduser(StreamingCommand):
    sa_name = Option(
        doc='''
    ...
    def stream(self, records):
        ...
        try:
            ...
            user_info = f'username: {username}, triggered Suspend User workflow action'
            logger.info(user_info)
            move_log = f'Suspending profile {device_user}'
...
dispatch(suspenduser, sys.argv, sys.stdin, sys.stdout, __name__)
