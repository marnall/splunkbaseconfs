...
HANDLER_NAME = "rwi_ed_configured_handler"
LOG_FILE_NAME = "rwi_ed_configured_handler.log"
...
APP_NAME = "Splunk_SA_rwi-executive-dashboard"

# constants for conf file names
SETUP_CONF_Name = "rwi_ed_setup"
APP_CONF_NAME = "app"
    ...
    def handleReload(self, confInfo):
        ...
        if configured == current:
            ...
            response, content = splunk.rest.simpleRequest(
                '/apps/local/Splunk_SA_rwi-executive-dashboard',
