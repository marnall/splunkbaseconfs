"""Take actor name as input from the user and show the
...
class Cred(GeneratingCommand):
    """Enrich CyberSixgill actor data for Splunk searches.

    This command takes an actor name as input and retrieves enriched data from the
    ...
    def generate(self) -> Generator[dict, None, None]:
        ...
        try:
            ...
            raw_records = sixgill_client.enrich_actor(str(value))
