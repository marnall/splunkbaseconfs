"""Take hash as input from the user and show the
...
class Cred(GeneratingCommand):
    """Enrich hash data from CyberSixgill for Splunk searches.

    This command takes a hash value as input and retrieves enriched data from the
    ...
    def generate(self) -> Generator[dict, None, None]:
        ...
        try:
            ...
            raw_records = sixgill_client.enrich_ioc("hash", str(ioc_value))
