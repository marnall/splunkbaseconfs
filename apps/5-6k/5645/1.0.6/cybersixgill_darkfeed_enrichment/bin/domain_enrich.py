"""Take domain as input from the user and show the
...
class Cred(GeneratingCommand):
    """Enrich domain data from CyberSixgill for Splunk searches.

    This command takes a domain name as input and retrieves enriched data from the
    ...
    def generate(self) -> Generator[dict, None, None]:
        ...
        try:
            ...
            raw_records = sixgill_client.enrich_ioc("domain", str(ioc_value))
