"""Take URL as input from the user and show the
...
class Cred(GeneratingCommand):
    """Enrich URL data from CyberSixgill for Splunk searches.

    This command takes a URL as input and retrieves enriched data from the
    ...
    def generate(self) -> Generator[dict, None, None]:
        ...
        try:
            ...
            raw_records = sixgill_client.enrich_ioc("url", str(ioc_value))
