"""Take post ID as input from the user and show the enriched data from cybersixgill end point.
"""
...
class Cred(GeneratingCommand):
    """Enrich CyberSixgill post IDs for Splunk searches.

    This command takes a post ID as input and retrieves enriched data from the
    ...
    def generate(self) -> Generator[dict, None, None]:
        ...
        try:
            ...
            raw_records = sixgill_client.enrich_postid(str(value))
