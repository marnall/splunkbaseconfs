...
class ModInputbugcrowd_api(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def get_scheme(self):
        ...
        scheme.add_argument(smi.Argument("starting_from", title="Starting From",
                                         ...
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("track_states", title="Track States",
    ...
    def get_checkbox_fields(self):
        checkbox_fields = []
        checkbox_fields.append("track_states")
