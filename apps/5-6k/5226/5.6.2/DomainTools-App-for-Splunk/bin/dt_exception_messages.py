...
service_not_available = "DomainTools Error: You have exceeded the maximum number of requests per minute allowed under your service level."
...
proxy_error = "Error connecting to server. Please confirm your splunk environment is able to reach https://api.domaintools.com"
...
not_found_error = "DomainTools Error: Could not find the result."
