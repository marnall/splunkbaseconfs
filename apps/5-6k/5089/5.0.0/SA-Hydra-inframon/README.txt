...
----------------------------------------
	...
	Version: 4.3.1
	Details:
			This supporting Add-on Collects API based data from vCenter and schedules jobs from the Scheduler and assigns it to run the worker processes on each data collection node.
