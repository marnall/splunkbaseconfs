...
def get_input_arguments():
    arguments = []
    arguments.append(smi.Argument("folder", title="Specify the folder to monitor",
                                     description="Specify the folder to monitor, splunk will collect any .fit file from here, and rename them to .fit.splunked once ingested",
...
def collect_events(helper, ew):
    ...
    command = 'for file in \"${folder}\"/*.fit ;  do python $SPLUNK_HOME/etc/apps/TA-fit_file/bin/fitdump.py /\"$file\" ; mv \"$file\" \"$file.splunked\"; done'
