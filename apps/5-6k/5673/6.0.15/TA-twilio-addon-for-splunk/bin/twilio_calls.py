...
class TWILIO_CALLS(smi.Script):

    def __init__(self):
        super(TWILIO_CALLS, self).__init__()

    def get_scheme(self):
        scheme = smi.Scheme('twilio_calls')
        scheme.description = 'twilio:calls'
...
if __name__ == '__main__':
    exit_code = TWILIO_CALLS().run(sys.argv)
    sys.exit(exit_code)
