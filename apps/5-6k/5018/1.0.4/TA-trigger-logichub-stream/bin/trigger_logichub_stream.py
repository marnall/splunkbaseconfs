...
import ta_trigger_logichub_stream_declare
...
if __name__ == "__main__":
    exitcode = AlertActionWorkertrigger_logichub_stream("TA-trigger-logichub-stream", "trigger_logichub_stream").run(sys.argv)
    sys.exit(exitcode)
