# This file is provided by the Splunk CIM app in versions > 4.9
# It is provides ability to write back into Splunk if required for adaptive framework
    ...
    def writeevents(
        ...
        if self.events:
            ...
            header_line = ModularAction.DEFAULT_HEADER % (
                ModularAction.get_header_item(
                    "index", index, ModularAction.DEFAULT_INDEX
                ),
