...
class GrandCentralAWSAccountsEAIHandler(base_eai_handler.BaseEAIHandler):
    ...
    def handleList(self, confInfo):
        ...
        for grand_central_aws_account in grand_central_aws_accounts_eai_response_payload['entry']:
            ...
            if enable_ou != '0':
                ...
                grand_central_aws_accounts_rest_path = '%s/%s' % (conf_handler_path, quote_plus(org_id))
    ...
    def handleCreate(self, confInfo):
        ...
        # params = [x.encode('utf-8') for x in auth_params]
        auth_params.update(server_params)
        # params = {x.encode('utf-8'): y.encode('utf-8') for x,y in auth_params.items()}
        params = auth_params
        ...
        # TODO convert the bytes to string
    ...
    def password_create(self, username, password):
        ...
        password_after = password_after.encode('utf-8')
