    ...
    def handleList(self, confInfo):
        ...
        for deployed_stackset in deployed_stacksets_eai_response_payload['entry']:
            ...
            for stack_instance in response['Summaries']:
                ...
                stack_instance_metadata['content']['grand_central_aws_account_link_alternate'] = '%s/%s' % ('/servicesNS/nobody/grand_central/grand_central_aws_accounts', stack_instance['Account'])
