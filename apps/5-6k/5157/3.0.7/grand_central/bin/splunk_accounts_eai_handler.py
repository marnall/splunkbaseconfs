...
class SplunkAccountsEAIHandler(base_eai_handler.BaseEAIHandler):
    ...
    def handleList(self, confInfo):
        ...
        """
        logger.info('Splunk accounts list requested on python version {}'.format(sys.version))
    ...
    def handleCreate(self, confInfo):
        ...
        confInfo -- The object containing the information about what is being requested.
        """
        logger.info('Splunk account creation requested on python version {}'.format(sys.version))
        ...
        splunk_accounts_rest_path = '/servicesNS/%s/%s/splunk_accounts/%s' % ('nobody', self.appName, quote_plus(params['name']))
