...
Please reference this blog post by Amazon Web Services on how to setup Control Tower and the Splunk integration : https://aws.amazon.com/blogs/awsmarketplace/monitoring-resources-in-an-aws-control-tower-environment-using-splunk-from-aws-marketplace/
...
4. Download [grand_central_202.spl](https://grandcentraldeployments.s3.amazonaws.com/grand_central_202.spl) file from S3 bucket and install on your Splunk instance. Splunk Cloud customers request to have the app installed.
...
***Contribution: Learn how you can build this app locally***
