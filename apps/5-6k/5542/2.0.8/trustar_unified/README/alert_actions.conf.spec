...
param.enrichment_enclave_ids = <string> Custom Enrichment Enclave IDs.
param.adjust_urgency = <list> Adjust Urgency?. It's a required parameter. It's default value is enabled.

[trustar_submit_event]
python.version = python3
param._cam = <json> Active response parameters.
param.report_title = <string> Report Title. It's a required parameter. It's default value is Splunk Threat Activity.
param.additional_comments = <string> Additional Comments.
param.custom_or_default = <list> Enclave. It's a required parameter. It's default value is default.
