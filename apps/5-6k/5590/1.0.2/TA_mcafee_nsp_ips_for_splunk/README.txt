Mcafee Network Security Platform IPS Add-on for Splunk
...
This app provides field extraction, cim mapping(Intrusion Detection, authentication, change) for Mcafee Network Security Platform IPS in Splunk.
...
Configure the input sourcetype as mcafee:nsp_ips, Heavy Forwarder and Indexer will rewrite the sourcetype.
...
|         |                                                                                                                  |
|---------|------------------------------------------------------------------------------------------------------------------|
| 1.0.2   | Support local sensors log collection                                                                             |
|---------|------------------------------------------------------------------------------------------------------------------|