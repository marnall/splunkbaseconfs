...
_alert_name = "vmware-edr-unisolate-device"
            ...
            with self._load_results("rt") as fh:
                ...
                def do_threaded_result(num, result):
                    try:
                        ...
                        org_name = result.get("orig_host", None)
                        ...
                        try:
                            ...
                            try:
                                ...
                                if edr_sensor is None:
                                    ...
                                    return
                                self._log.debug("edr_sensor={}".format(edr_sensor.get_info()))
                                self._log.info("action=unisolate_sensor, hostname: {}".format(hostname))
                                edr_sensor.unisolate()
                            except KeyError:
