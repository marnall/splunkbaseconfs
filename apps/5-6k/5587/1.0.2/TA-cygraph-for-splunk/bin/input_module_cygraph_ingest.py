...
def get_input_arguments():
    arguments = []
    arguments.append(smi.Argument("username", title="Username",
                                     description="",
                                     required_on_create=True,
                                     required_on_edit=False))
    arguments.append(smi.Argument("password", title="Password",
                                     description="",
                                     required_on_create=True,
                                     required_on_edit=False))
    return arguments
...
def collect_events(helper, ew):
    ...
    command = 'sudo /opt/splunk/bin/splunk add index cygraph_ingest -maxDataSize auto_high_volume -auth ${username}:${password}'
