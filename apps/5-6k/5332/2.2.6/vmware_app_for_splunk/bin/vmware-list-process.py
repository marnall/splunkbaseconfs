# - List Processes
#     - `Documentation <https://developer.carbonblack.com/reference/carbon-black-cloud/cb-defense/latest/live-response-api/#ps>`_
...
class VmwareListProcess(VmwareCBCAlertAction):
            ...
            with self._load_results("rt") as fh:
                ...
                def do_threaded_result(num, result):
                    try:
                        ...
                        self._log.debug("list processes for hostname: {}".format(hostname))
                        try:
...
if __name__ == '__main__':
    ...
    try:
        ...
        modaction = VmwareListProcess(sys.stdin.read(), action_name=_alert_name)
        modaction.main()
