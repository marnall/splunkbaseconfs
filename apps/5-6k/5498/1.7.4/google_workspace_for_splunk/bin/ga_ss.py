...
kl = KennyLoggins()
log = kl.get_logger(_APP_NAME, "spreadsheet-modularinput", logger.INFO)

modular_input = GSuiteModularInput(app_name=_APP_NAME, scheme={
    "title": "Google Workspaces Spreadsheet Data",
    "description": "Consumes Spreadsheet Data from GWorkspaces",
    "args": [
        ...
        {"name": "ss_id", "description": "The Spreadsheet ID", "title": "Spreadsheet ID", "required": True},
        {"name": "ss_sheet", "description": "The Sheet ID", "title": "Sheet ID", "required": True},
...
def run():
    log.info("action=start_modular_input name=ga_ss")
    ...
    try:
        ...
        modular_input.setup_gw("spreadsheets")
        modular_input.get_spreadsheet()
