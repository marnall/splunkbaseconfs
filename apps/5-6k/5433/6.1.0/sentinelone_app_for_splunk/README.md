...
- Single Instance 
  ...
  - Only the SentinelOne App ([sentinelone_app_for_splunk](https://splunkbase.splunk.com/app/5433/>))
...
- Single Instance + Heavy Forwarder 
  ...
  - Single Instance:
    ...
    - SentinelOne App ([sentinelone_app_for_splunk](https://splunkbase.splunk.com/app/5433/>))
...
- Configurations Dashboard
  ...
  - There is a dashboard that is not within the navigation. It can be loaded using the following url: `https://<yourSplunk>/<language>/sentinelone_app_for_splunk/sentinelone_current_configurations/`. This dashboard displays configured information for each input, and how they interact with each other configuration.
