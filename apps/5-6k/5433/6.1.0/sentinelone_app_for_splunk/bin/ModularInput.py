...
class ModularInput:
    ...
    # Begin Methods
    def __init__(self, app_name=None, scheme={}, cim_fields=None, **kwargs):
        try:
    ...
    def _checkpoint(self, key, value=False, checkpoint_time=None, is_object=False, is_reload_check=False):
        ...
        if not value:
            ...
            try:
                if os.path.isfile(chkpointfile):
                    ...
                    if is_reload_check:
                        # If the get_checkpoint is called from reload check
                        # Will return False if checkpoint file is not exists
                        self.info("The reload checkpoint file was not found in the checkpoint directory.")
                        return False
    ...
    def get_checkpoint(self, key, isObject=False, isReloadCheck=False):
        return self._checkpoint(key, value=False, is_object=isObject, is_reload_check=isReloadCheck)
