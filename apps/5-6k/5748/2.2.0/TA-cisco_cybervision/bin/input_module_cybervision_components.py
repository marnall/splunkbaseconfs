...
def collect_events(helper, ew):
    ...
    try:
        ...
        while True:
            ...
            data = utils.request_get(helper, "components", config_details, params)
            if data and (page == 1):
            ...
            utils.ingest_in_splunk(
                helper, ew, data, sourcetype, additional_fields, source="Components"
            )
        ...
        helper.log_error(utils.DATA_COLLECTION_ERROR.format("Components", e))
