    ...
    with f:
        try:
            ...
            while isinstance(res, NeedTANResponse):
                raise Exception("NeedTANResponse required")
                return

            # I don't know the structure of a holding response, so I write it as a string in the meantime
            data = {}
            data['Holdings'] = str(res)
