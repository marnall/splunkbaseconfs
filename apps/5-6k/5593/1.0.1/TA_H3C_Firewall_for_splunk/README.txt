H3C Firewall Add-on for Splunk
...
This app provides field extraction, cim mapping(network) for H3C Firewall in Splunk.
...
Configure the input sourcetype as h3c:firewall.
