...
For additional documentation or access to the latest version of this app, please visit [openintelligence-nli-app](https://openintelligence.com.au/products/onli-app).
...
## Troubleshooting
If the Webtools Add-on is not installed or the App is unable to connect to the licensed OI-Rest API, the App will return an error message.
...
## Feedback/Support
Both Development and Production licenses come with standard support for the Rest API and this App. 
Our Trial License does not include any support offering but please feel free to drop us an email to alonso.marquez@openintelligence.com.au or visit our [contact_us](https://openintelligence.com.au/contact_us) page if you have any problem, question or suggestion.
