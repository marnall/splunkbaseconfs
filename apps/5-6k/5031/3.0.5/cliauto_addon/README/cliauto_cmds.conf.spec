...
# with the CLI Auto Add-on for Splunk app.
# 
# cliauto_cmds.conf is meant to correspond with cliauto_addon.conf
#
...
# job. The cliauto_addon.conf is related since it contains global settings for the
# app.
