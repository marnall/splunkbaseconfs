...
fields_proxy = [
    ...
    field.RestField("proxy_type", required=False, encrypted=False, default="http", validator=None),
    field.RestField(
        "proxy_url",
        required=False,
        encrypted=False,
    ...
    field.RestField("proxy_rdns", required=False, encrypted=False, default=None, validator=None),
]
...
endpoint = MultipleModel(
    "ta_crowdstrike_falcon_discover_settings",
