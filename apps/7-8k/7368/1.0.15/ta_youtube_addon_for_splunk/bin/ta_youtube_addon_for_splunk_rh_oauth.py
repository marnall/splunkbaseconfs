...
logger = log.Logs().get_logger('ta_youtube_addon_for_splunk_rh_oauth2_token')
...
class ta_youtube_addon_for_splunk_rh_oauth2_token(admin.MConfigHandler):
    ...
    def setup(self):
        if self.requestedAction == admin.ACTION_EDIT:
            ...
            for arg in ('url', 'method', 'grant_type', 'code',
    ...
    def handleEdit(self, confInfo):
        try:
            ...
            #     # Handle the error appropriately, e.g., set content to None or raise a custom exception
            #     content = None
    ...
    def getProxyDetails(self):
        ...
        ), "ta_youtube_addon_for_splunk", realm="__REST_CREDENTIAL__#ta_youtube_addon_for_splunk#configs/conf-ta_youtube_addon_for_splunk_settings")
        # Get Conf object of apps settings
        conf = cfm.get_conf('ta_youtube_addon_for_splunk_settings')
...
if __name__ == "__main__":
    admin.init(ta_youtube_addon_for_splunk_rh_oauth2_token, admin.CONTEXT_APP_AND_USER)
