...
The HTTP Event Collector receives the attack events data sent by Contrast Security ADR Platform. The data is then parsed using sourcetype and stored in the index. Data mapping is carried out using the Intrusion Detection data model in the Common Information Model (CIM).
