...
def collect_events(helper, ew):
    ...
    base_url = "https://auvikapi." + opt_region + ".my.auvik.com/v1/inventory/entity/audit"
    ...
    timestamp2 = helper.get_check_point('last_audit')
        ...
        try:
            ...
            if timestamp2 is None:
                ...
                for log in r_text.get('data', []):  # Safely handle missing 'data' key
                    ...
                    timestamp1 = log['attributes']['dateStarted']
            ...
            checkpoint = r_text['data'][-1]['attributes']['dateStarted']
    ...
    helper.save_check_point('last_audit', checkpoint)
