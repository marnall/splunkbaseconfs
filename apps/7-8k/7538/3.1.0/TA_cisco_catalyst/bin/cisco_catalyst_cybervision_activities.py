"""Modular input for Cyber Vision Activities."""
...
CONNECTED_LOG = (
    ...
    "filter_value=cisco_catalyst_cybervision_activities://{}, status=Connected,"
)
NOT_CONNECTED_LOG = (
    "instance={}, product=Cisco Cyber Vision, "
    "filter_value=cisco_catalyst_cybervision_activities://{}, status=Not Connected,"
)


class CiscoCyberVisionActivities(smi.Script):
    """Get the Activity details from Cisco CyberVision Server."""

    def __init__(self):
        """Initialise CiscoCyberVisionActivities class."""
        super(CiscoCyberVisionActivities, self).__init__()

    def get_scheme(self):
        """Load the arguments in the Configuration page."""
        scheme = smi.Scheme('cisco_catalyst_cybervision_activities')
        scheme.description = (
    ...
    def stream_events(self, inputs: smi.InputDefinition, ew: smi.EventWriter):
        ...
        try:
            ...
            logger = logger_manager.get_logger(
                f"cybervision_activities_{input_name}", input_conf["logging_level"]
            )
            ...
            sourcetype = "cisco:cybervision:activities"
            endpoint = "/activities"
            ...
            while True:
                ...
                data = utils.cybervision_request_get("activities", config_details, params)
                ...
                utils.cybervision_ingest_in_splunk(
                    input_conf, ew, data, sourcetype, additional_fields, source="Activities"
                )
            ...
            logger.error(utils.DATA_COLLECTION_ERROR.format("Activities", e))
...
if __name__ == '__main__':
    exit_code = CiscoCyberVisionActivities().run(sys.argv)
    sys.exit(exit_code)
