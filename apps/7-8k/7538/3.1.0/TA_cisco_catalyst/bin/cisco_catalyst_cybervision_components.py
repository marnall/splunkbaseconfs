"""Modular input for Cyber Vision Components."""
...
CONNECTED_LOG = (
    ...
    "filter_value=cisco_catalyst_cybervision_components://{}, status=Connected,"
)
NOT_CONNECTED_LOG = (
    "instance={}, product=Cisco Cyber Vision, "
    "filter_value=cisco_catalyst_cybervision_components://{}, status=Not Connected,"
)


class CiscoCyberVisionComponents(smi.Script):
    """Get the Components details from Cisco CyberVision Server."""

    def __init__(self):
        """Initialise CiscoCyberVisionComponents class."""
        super(CiscoCyberVisionComponents, self).__init__()

    def get_scheme(self):
        """Load the arguments in the Configuration page."""
        scheme = smi.Scheme('cisco_catalyst_cybervision_components')
        scheme.description = (
    ...
    def stream_events(self, inputs: smi.InputDefinition, ew: smi.EventWriter):
        ...
        try:
            ...
            logger = logger_manager.get_logger(
                f"cybervision_components_{input_name}", input_conf["logging_level"]
            )
            ...
            while True:
                ...
                data = utils.cybervision_request_get("components", config_details, params)
                ...
                utils.cybervision_ingest_in_splunk(
                    input_conf, ew, data, sourcetype, additional_fields, source="Components"
                )
            ...
            logger.error(utils.DATA_COLLECTION_ERROR.format("Components", e))
...
if __name__ == '__main__':
    exit_code = CiscoCyberVisionComponents().run(sys.argv)
    sys.exit(exit_code)
