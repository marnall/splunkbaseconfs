...
Version 1.0.8: Mar 21, 2026
Corrected an issue found with timestamp conversion while Trellix has changed the datetime format from millis to nanos. [Issue](<https://github.com/lgodoys/Trellix_Splunk/issues/2>)
