...
from silent_push_helpers.validators import CorrelationValidator, SplunkKvStoreRest
import logging
...
fields_correlation_settings = [
    ...
    field.RestField(
        ...
        required=False,
        encrypted=False,
        default='index=main sourcetype!=silent_push_*',
        validator=validator.String(
            max_len=8192, 
            min_len=0, 
        )
...
endpoint = MultipleModel(
    'silentpushappforsplunk_settings',
    models=[
        model_proxy, 
        model_logging, 
