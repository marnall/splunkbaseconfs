...
class SBGIsovalentInput(smi.Script):
    ...
    """
    def __init__(self):
        super(SBGIsovalentInput, self).__init__()
    ...
    def get_scheme(self) -> smi.Scheme:
        ...
        """
        scheme = smi.Scheme("sbg_isovalent_input")
...
if __name__ == "__main__":
    exit_code = SBGIsovalentInput().run(sys.argv)  # pragma: no cover
