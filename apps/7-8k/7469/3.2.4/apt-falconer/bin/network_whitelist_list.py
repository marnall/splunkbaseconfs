...
class NetworkWhitelistListHandler(PersistentServerConnectionApplication):
    def __init__(self, command_line, command_arg):
        super(NetworkWhitelistListHandler, self).__init__()
    ...
    def log(self, message: str):
        ...
        try:
            with open(DEBUG_PATH, "a", encoding="utf-8") as f:
                f.write(f"[{datetime.datetime.utcnow().isoformat()}] [network_whitelist_list] {message}\n")
        except Exception:
            pass
