...
class ModInputbugfender_app_issues(base_mi.BaseModInput):

    def __init__(self):
        use_single_instance = False
        super(ModInputbugfender_app_issues, self).__init__("ta_bugfender_add_on_for_splunk", "bugfender_app_issues", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputbugfender_app_issues, self).get_scheme()
        scheme.title = ("Bugfender App Issues")
        ...
        scheme.add_argument(smi.Argument("app_id", title="Bugfender App ID",
                                         ...
                                         required_on_create=True,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("issue_status", title="Issue Status",
                                         description="",
                                         required_on_create=True,
                                         required_on_edit=False))
    ...
    def validate_input(helper, definition):
        ...
        helper.log_debug(f"initial_start_date: {initial_start_date}")
...
if __name__ == "__main__":
    exitcode = ModInputbugfender_app_issues().run(sys.argv)
    sys.exit(exitcode)
