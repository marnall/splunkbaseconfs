...
ADDON_NAME = "SIEMBazaar_TA_Dynatrace_audit_logs"
...
def get_account_api_key(session_key: str, account_name: str):
    cfm = conf_manager.ConfManager(
        session_key,
        ADDON_NAME,
        realm=f"__REST_CREDENTIAL__#{ADDON_NAME}#configs/conf-SIEMBazaar_TA_Dynatrace_audit_logs_account",
    )
    account_conf_file = cfm.get_conf("SIEMBazaar_TA_Dynatrace_audit_logs_account")
...
def stream_events(inputs: smi.InputDefinition, event_writer: smi.EventWriter):
    ...
    # {
    #   "dynatrace_audit_logs://<input_name>": {
