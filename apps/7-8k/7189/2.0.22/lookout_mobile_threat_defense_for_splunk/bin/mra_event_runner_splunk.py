...
from helpers import formatProxies, eventTypeDisplay, printEvent, killZombies
...
def main() -> None:
    ...
    logFile = os.path.join(log_directory, "lookout_mobile_threat_defense_for_splunk.log")
    ...
    try:
        ...
        logger.info("Current Version: {}".format(manifest["info"]["id"]["version"]))
    except Exception as e:
        logger.error("Failed to read application version from app.manifest: {}".format(e))
