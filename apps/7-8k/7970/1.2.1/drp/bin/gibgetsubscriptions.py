...
class gibgetsubscriptions(GeneratingCommand):
    ...
    def generate(self):
        logger = Utils.get_logger(
            ...
            log_filename="modinput_get_subscriptions.log"
        )
        ...
        try:
            ...
            subscriptions = poller.get_subscriptions()
...
dispatch(gibgetsubscriptions, sys.argv, sys.stdin, sys.stdout, __name__)
