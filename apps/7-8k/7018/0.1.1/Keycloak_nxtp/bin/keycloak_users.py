...
class Input(smi.Script):
    ...
    def get_scheme(self):
        scheme = smi.Scheme("keycloak_users")
        scheme.description = "keycloak_users input"
        ...
        for input_name, input_item in inputs.inputs.items():
            ...
            try:
                ...
                for realm in Request(
                    ...
                    for user in Request(
                        management_connection=api_manager,
                        endpoint=f"realms/{realm_name}/users",
                        http_request="GET",
                    ).execute():
                        ...
                        event_writer.write_event(
                            smi.Event(
                                ...
                                source=f"{host}:{realm_name}:users",
