...
class Input(smi.Script):
    ...
    def get_scheme(self):
        scheme = smi.Scheme("keycloak_events")
        scheme.description = "keycloak_events input"
    ...
    def stream_events(self, inputs: smi.InputDefinition, event_writer: smi.EventWriter):
        ...
        for input_name, input_item in inputs.inputs.items():
            ...
            last_fetch = checkpoint.get("last_fetch_events")
            ...
            try:
                ...
                for realm in Request(
                    ...
                    eventlog = list(
                        Request(
                            management_connection=api_manager,
                            endpoint=f"realms/{realm['realm']}/events",
                    ...
                    for event in eventlog:
                        ...
                        event_writer.write_event(
                            smi.Event(
                                ...
                                source=f"{host}:{realm['realm']}:events",
                ...
                checkpoint.update("last_fetch_events", new_start_from)
