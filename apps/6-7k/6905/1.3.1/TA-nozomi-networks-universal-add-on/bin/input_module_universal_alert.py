...
class UniversalApi:
    ...
    def __init__(self, name, helper):
        ...
        self.receive_alert_updates = helper.get_arg("receive_alert_updates")
        self.helper = helper
    ...
    def __resource_time_field(self):
        ...
        if resource == "alerts" and self.receive_alert_updates:
            return "record_updated_at"
        if resource == "alerts":
...
def collect_events(helper, ew):
    universal_api = UniversalApi('alerts', helper)
