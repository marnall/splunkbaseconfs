...
from utils import setup_logging, regex_match
from constants import ENRICHMENT_ERROR, RE_IP
from qintel_qsentry_feed_ip import QintelQSentryIP as QSentryIP
import ipaddress
...
SEARCH_MAP = {
    'ip_field': {'field': 'ip_field', 'regex': RE_IP, 'client': QSentryIP}
}
