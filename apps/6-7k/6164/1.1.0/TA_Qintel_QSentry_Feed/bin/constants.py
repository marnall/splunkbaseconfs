...
VERSION = '1.0.1'
UA = 'Qintel QSentry Feed Splunk Add-on {}'.format(VERSION)

APP_NAME = 'TA_Qintel_QSentry_Feed'


CACHE_LIMIT = 2  # hours
MAX_CACHE_LIMIT = 12  # hours

FEED_KV_STORE = 'qintel_qsentry_feed'
...
REALM = f'__REST_CREDENTIAL__#{APP_NAME}#configs/conf-qintel_qsentry_feed_settings'
CONFIG_FILE = 'qintel_qsentry_feed_settings'