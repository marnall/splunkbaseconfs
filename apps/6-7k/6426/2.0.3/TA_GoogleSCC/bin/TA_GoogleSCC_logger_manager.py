...
def setup_logging(log_name, input_name=None, account_name=None):
    """Set logger for the given log_name."""
    custom_msg = ""
    if input_name:
        custom_msg = "input={} | ".format(input_name)
    elif account_name:
        custom_msg = "account={} | ".format(account_name)
    ...
    cfg = cli.getConfStanza('ta_googlescc_settings', 'logging')
