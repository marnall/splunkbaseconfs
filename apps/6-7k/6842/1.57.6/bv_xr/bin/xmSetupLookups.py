...
if __name__ == '__main__':
    try:
        ...
        defaultResourceMappingFile=splunkHome + "/etc/apps/bv_xr/config/resource-mapping-default.json"
        resourceMappingFile=splunkHome + "/etc/apps/bv_xr/config/resource-mapping.json"
        ...
        defaultCategoriesFile=splunkHome + "/etc/apps/bv_xr/lookups/categories-default.csv"
        categoriesFile=splunkHome + "/etc/apps/bv_xr/lookups/categories.csv"
        ...
        initAssetsFile=splunkHome + "/etc/apps/bv_xr/lookups/bv_assets-default.csv"
        assetsFile=splunkHome + "/etc/apps/bv_xr/lookups/bv_assets.csv"
        ...
        initActorsFile=splunkHome + "/etc/apps/bv_xr/lookups/bv_actors-default.csv"
        actorsFile=splunkHome + "/etc/apps/bv_xr/lookups/bv_actors.csv"
        ...
        #defaultDataDictionaryFile=splunkHome + "/etc/apps/bv_xr/config/data-dictionary-default.json"
        #dataDictionaryFile=splunkHome + "/etc/apps/bv_xr/config/data-dictionary.json"
        ...
        defaultPropertiesFile=splunkHome + "/etc/apps/bv_xr/config/scm-framework-default.properties"
        propertiesFile=splunkHome + "/etc/apps/bv_xr/config/scm-framework.properties"
        ...
        defaultSavedSearchesFile=splunkHome + "/etc/apps/bv_xr/default/savedsearches.default"
        savedSearchesFile=splunkHome + "/etc/apps/bv_xr/default/savedsearches.conf"
