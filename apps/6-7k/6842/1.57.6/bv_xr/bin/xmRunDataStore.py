...
if __name__ == '__main__':
    ...
    try: 
        ...
        # Migration for Cloud Certification, move $SPLUNK_HOME/var/lib/scm -> $SPLUNK_HOME/etc/apps/bv_xr/scm
        ...
        if "var" in mongo_dbpath:
            ...
            new_scm_home = "$(SPLUNK_HOME)/etc/apps/bv_xr"
        ...
        #mongo_binary = splunkHome + '/etc/apps/bv_xr/bin/' +  platform.system() + '/' + platform.architecture()[0] + '/mongo'
        #mongo_binary = './' +  platform.system() + '/' + platform.architecture()[0] + '/mongo'
        if int(m_version) >= 9:
            mongo_binary = splunkHome + '/etc/apps/bv_xr/bin/' +  platform.system() + '/' + platform.architecture()[0] + '/mongo4'
        else:
            mongo_binary = splunkHome + '/etc/apps/bv_xr/bin/' +  platform.system() + '/' + platform.architecture()[0] + '/mongo'
