...
The Extreme Rules writes/reads files in the following $(SPLUNK_HOME)/etc/apps/bv_xr/scm directory:

    $(SPLUNK_HOME)/etc/apps/bv_xr/scm/backups
       Location for Cognitive Models that have been exported.
    $(SPLUNK_HOME)/etc/apps/bv_xr/scm/db
       Location of the Mongo Database Files (for default Mongo installation).
    $(SPLUNK_HOME)/etc/apps/bv_xr/scm/models
       Location of the Cognitive Model files supporting UI.
    $(SPLUNK_HOME)/etc/apps/bv_xr/scm/temp
...
The Extreme Rules utilizes files the following lookup files in $(SPLUNK_HOME/etc/apps/bv_xr/lookups:
    $(SPLUNK_HOME/etc/apps/bv_xr/lookups/APPLICATION.context.csv
       Definition of Application Level Contexts that will be imported into data store.
    $(SPLUNK_HOME/etc/apps/bv_xr/lookups/bv_actors-default.csv
       Initial installation you can seed a default set of actors by editing this file.
    $(SPLUNK_HOME/etc/apps/bv_xr/lookups/bv_actors.csv
       Resource file extracted from default that you can seed with actors on installation.
    $(SPLUNK_HOME/etc/apps/bv_xr/lookups/app_types.csv
       Definition of Applications Supported
    $(SPLUNK_HOME/etc/apps/bv_xr/lookups/asset_types.csv
       Definition of supported Asset Types.
    $(SPLUNK_HOME/etc/apps/bv_xr/lookups/bv_assets-default.csv
       Initial installation you can seed a default set of assets by editing this file.
    $(SPLUNK_HOME/etc/apps/bv_xr/lookups/bv_assets.csv
       Resource file extracted from default that you can seed with assets on installation.
    $(SPLUNK_HOME/etc/apps/bv_xr/lookups/categories-default.csv
       Initial installation of bv_xr seeds categories.csv with this file.
    $(SPLUNK_HOME/etc/apps/bv_xr/lookups/categories.csv
       Definition of supported actor categories.
    $(SPLUNK_HOME/etc/apps/bv_xr/config/resource-mapping-default.json
       Initial installation seeds resource-mapping.json with this file.
    $(SPLUNK_HOME/etc/apps/bv_xr/config/resource-mapping.json
       Definition of resource mappings.
    $(SPLUNK_HOME/etc/apps/bv_xr/config/scm-framework-default.properties
       Initial installation of bv_xr seeds scm-framework.properties with this file.
    $(SPLUNK_HOME/etc/apps/bv_xr/configlookups/scm-framework.properties
       Definition of properties used by bv_xr.
    $(SPLUNK_HOME/etc/apps/bv_xr/lookups/scm-synonyms.csv.
       Definition of hedge synonyms for Extreme Search supported by bv_xr.
    $(SPLUNK_HOME/etc/apps/bv_xr/lookups/signal_types.csv
       Definition of signal types supported by bv_xr
