...
class ApiQuery(StreamingCommand):
    ...
    def stream(self, records):
        ...
        for record in records:
            field = str(record[self.field])
            logger.info('stage="gathering splunk value for streaming query" value="'+field+'"')
