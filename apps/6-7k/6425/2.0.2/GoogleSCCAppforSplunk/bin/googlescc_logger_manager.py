"""This module is used to manage logs in the App."""
import logging
...
def get_log_level(session_key):
    ...
    conf_endpoint = (
        "/servicesNS/nobody/{}/configs/conf-ta_googlescc_settings/logging".format(
...
def setup_logging(log_name, session_key):
    ...
    log_file = make_splunkhome_path(
        ["var", "log", "GoogleSCCAppforSplunk", "%s.log" % log_name]
    )
