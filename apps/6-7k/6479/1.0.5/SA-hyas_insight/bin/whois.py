...
from constants import WHOIS, BASE_URL, WHOIS_IOC
                ...
                if validated_ioc_name in self.ioc_names.keys():
                    ...
                    if hyas_data == 401:
                        ...
                        for item in hyas_data:
                            ...
                            data_final = Data_Parsing.whois_parse_data(final_data)
                            yield data_final
                    else:
...
dispatch(whois, sys.argv, sys.stdin, sys.stdout, __name__)