from __future__ import absolute_import, division, print_function, \
    unicode_literals
import os, sys
from constants import BASE_URL, SAMPLE, SAMPLE_IOC
...
@Configuration()
class sample(GeneratingCommand):
    ioc_names = SAMPLE_IOC
                    ...
                    if hyas_data == 401:
                        ...
                        if len(hyas_data) > 0:
                            for item in hyas_data:
                                ...
                                data_final = Data_Parsing.sample_parse_data(
                                    final_data)
                                yield data_final
                        else:
...
dispatch(sample, sys.argv, sys.stdin, sys.stdout, __name__)
