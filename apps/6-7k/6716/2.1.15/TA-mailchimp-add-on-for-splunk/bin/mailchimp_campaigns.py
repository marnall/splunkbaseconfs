...
class MAILCHIMP_CAMPAIGNS(smi.Script):

    def __init__(self):
        super(MAILCHIMP_CAMPAIGNS, self).__init__()

    def get_scheme(self):
        scheme = smi.Scheme('mailchimp_campaigns')
        scheme.description = 'Campaigns'
    ...
    def stream_events(self, inputs, ew):
        ...
        url = f"https://{match_str}.api.mailchimp.com/3.0/campaigns?offset={off}&count={num}"
        ...
        for ids in r["campaigns"]:
            ...
            if state is None:
                ...
                event = smi.Event(
                    ...
                    sourcetype='mailchimp:campaigns',
                )
...
if __name__ == '__main__':
    exit_code = MAILCHIMP_CAMPAIGNS().run(sys.argv)
    sys.exit(exit_code)
