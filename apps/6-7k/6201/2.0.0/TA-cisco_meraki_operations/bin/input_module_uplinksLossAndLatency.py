...
def get_data(api_key,org):
    headers = {'X-Cisco-Meraki-API-Key': api_key}
    response = requests.get(f'https://api.meraki.com/api/v1/organizations/{org}/devices/uplinksLossAndLatency', headers=headers)
...
#    account = helper.get_user_credential_by_id("account id")
    ...
    all_data = get_data(global_api_key,global_organization_id)
