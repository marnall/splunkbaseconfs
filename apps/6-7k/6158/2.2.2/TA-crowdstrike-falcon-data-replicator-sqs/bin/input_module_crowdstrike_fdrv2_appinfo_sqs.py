...
def collect_events(helper, ew):
    ...
    #FDR SQS and S3 configuration settings
    sqs = boto3.resource('sqs', region_name=region, aws_access_key_id=clientID, aws_secret_access_key=secret)
    s3 = boto3.client('s3', region_name=region, aws_access_key_id=clientID, aws_secret_access_key=secret)
    queue = sqs.Queue(url=sqs_queue)
