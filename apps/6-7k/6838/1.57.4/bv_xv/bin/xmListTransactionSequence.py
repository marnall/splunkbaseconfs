...
def usage(message):
    ...
    usageStatement = "xmListTransactionSequence [TRANSACTION_NAME transactionName] [MODEL_NAME modelName] [SEQUENCE_NAME name]";
...
if __name__ == '__main__':
    ...
    lastArg = ''
    logging.info("---------------------------------------------------------------------------------------")
    logging.info("xmListTransactionSequence starting, args " + repr(sys.argv) + "]");
    ...
    try:
        ...
        logging.info("Calling xmListTransactionSequence with arguments: [" + repr(argList) + "]")
        saUtils.runProcess(sys.argv[0], "xmListTransactionSequence", argList, False)
        logging.info("---------------------------------------------------------------------------------------")
