...
def usage(message):
    ...
    usageStatement = "xmListGraph GRAPH_TYPE graphType GRAPH_NAME graphName [MODEL_NAME modelName]";
...
if __name__ == '__main__':
    ...
    lastArg = ''
    logging.info("---------------------------------------------------------------------------------------")
    logging.info("xmListGraph starting, args " + repr(sys.argv) + "]");
    ...
    try:
        ...
        logging.info("Calling xmListGraph with arguments: [" + repr(argList) + "]")
        saUtils.runProcess(sys.argv[0], "xmListGraph", argList, False)
        logging.info("---------------------------------------------------------------------------------------")
