...
if __name__ == '__main__':
    ...
    try:
        if len(sys.argv) >1:
                                    ...
                                    if appKeyword == '':
                                        if withKeyword == '':
                                            ...
                                            if arg.lower().startswith("points="):
                                                ...
                                                errString = "xmUpdateConcept-F-003: Invalid argument: " + arg
            ...
            raise Exception("xmUpdateConcept-F-001: Usage: xmUpdateConceptShape concept[,concept]* FROM context [IN container] [BY class] [SCOPED scope] [APP app] [shape='shapeStr'] [; shape='shapeStr'] ]*")

        #if points == '':
        #    raise Exception("xmUpdateConcept-F-007: parameter 'points' not found")
        ...
        saUtils.runProcess(sys.argv[0], "xmUpdateConceptShape", argList, True)
