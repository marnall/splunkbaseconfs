...
request_timeout = timeout of defender request
lookback = lookback to account for potential log delay in API
...
azure_app_account = account created in configuration page using client_id and client_secret
tenant_id = tenant_id of azure account
location = location of server close to user's geolocation
start_date = date from where user wants to collect data, in a specific format
request_timeout = timeout of defender request
lookback = lookback to account for potential log delay in API
...
[microsoft_defender_threat_intelligence_datasets://<name>]
azure_app_account = account created in configuration page using client_id and client_secret
datasets = list of datasets to collect data from
