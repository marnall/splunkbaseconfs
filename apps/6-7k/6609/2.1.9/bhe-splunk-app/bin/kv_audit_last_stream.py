...
KV_COLLECTION_NAME = "bhe-kv-audit-last-stream"

def get_audit_last_data_stream(service):
...
def insert_audit_last_data_stream(service, new_timestamp):
...
def update_audit_last_data_stream(service, new_timestamp):
