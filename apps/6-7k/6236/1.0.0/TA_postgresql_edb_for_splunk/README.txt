PostgreSQL EnterpriseDB (EDB) Add-on for Splunk
...
This app provides field extraction, cim mapping(authentication) for PostgreSQL EnterpriseDB (EDB) in Splunk.

The field extraction only accepts local csv file logging from PostgreSQL EnterpriseDB (EDB).

================================================
Configuring PostgreSQL EnterpriseDB (EDB)
================================================

1. Configure audit setting in postgresql.conf:
...
Configuring Splunk
================================================
This app need to install on Splunk Search Head and forwarder(PostgreSQL DB Server), and optionally installed on Indexer/Heavy Forwarder.
...
Configure the input sourcetype as postgresql:edb:audit.
