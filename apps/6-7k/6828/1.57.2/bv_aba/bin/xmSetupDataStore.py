...
if __name__ == '__main__':
    ...
    tmpFilename = splunkHome + '/etc/apps/bv_aba/config/tmp.csv'
        ...
        if mongo_config == "standalone":
            ...
            if status  == "FAILURE":
               ...
               if updateInput  == "true":
                   ...
                   endpoint = '/servicesNS/nobody/bv_aba/data/inputs/script/%24SPLUNK_HOME%252Fetc%252Fapps%252Fbv_aba%252Fbin%252FxmRunDataStore.py'
                   postArgs = {'disabled':'0'}
