...
#
# File: deprecation_message_housekeeping.py - Version 3.8.1
...
from dpshared.AbstractAuthorizationManager import LogEntryStatus


class DeprecationMessageHouseKeeper(AmeModularInput):
    def get_scheme(self) -> Scheme:
        scheme = Scheme("AME Deprecation Message Housekeeping")
        scheme.description = "This task periodically checks for the usage of deprecated features."
    ...
    def discover_deprecations(self) -> None:
        self.service_factory.deprecation_service.discover_deprecations()
...
if __name__ == "__main__":
    sys.exit(DeprecationMessageHouseKeeper().run(sys.argv))
