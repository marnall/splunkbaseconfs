...
#
# File: backup_keeping.py - Version 3.8.1
...
class BackupKeeper(AmeModularInput):
    def get_scheme(self) -> Scheme:
        scheme = Scheme("AME backup execution")
        scheme.description = "This task does create backups for all tenants."
    ...
    def handle_stream_events(
        ...
        try:
            backup_collection_service = self.service_factory.collection_backup_service
            backup_collection_service.backup_shared_collections()
...
if __name__ == "__main__":
    sys.exit(BackupKeeper().run(sys.argv))
