# D3 DYNAMIC BUBBLE by GoAhead

## Introduction

RENEWAL!
"D3 DYNAMIC BUBBLE" is a custom viz App to show the circular packing chart by using "D3.js".
...
We have two styles.
1. [D3 BUBBLE](https://splunkbase.splunk.com/app/6408/): Using legacy D3 v3.5 
2. (this) D3 DYNAMIC BUBBLE: implemented more color variety and force simulation Using D3 v6.7
...
D3 DYNAMIC BUBBLE is a standard Splunk Visualization App and requires no special configuration.
...
## Usage
 ...
 - Functions on Visualization Formatter
    ...
    - `bubble movement by forceSimulation supported by default, you can disable it in "forceSimulation" settings.`
