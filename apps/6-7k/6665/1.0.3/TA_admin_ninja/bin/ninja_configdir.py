...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Config Directory",
    "description": "Get data about the various knowledge objects in your environment.",
...
if __name__ == "__main__":
    ...
    modinput = modinput_ninja("ninja_configdir", INPUT_SCHEME_JSON, vars)
