...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Lookups",
    "description": "Get data about Splunk Lookups configured in your environment.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/data/lookup-table-files",
        "uri_query": {
            'output_mode': 'json',
            'f': [
                'disabled',
    ...
    modinput = modinput_ninja("ninja_lookups", INPUT_SCHEME_JSON, vars)
