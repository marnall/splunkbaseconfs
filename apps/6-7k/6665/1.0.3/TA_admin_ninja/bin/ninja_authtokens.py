...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Authentication Tokens",
    "description": "Get data about the Splunk Authentication Tokens set up in your environment.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/authorization/tokens",
        "uri_query": {
            'output_mode': 'json'
        },
    ...
    modinput = modinput_ninja("ninja_authtokens", INPUT_SCHEME_JSON, vars)
