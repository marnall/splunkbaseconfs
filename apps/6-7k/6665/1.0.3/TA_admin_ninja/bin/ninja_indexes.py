...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Indexes",
    "description": "Get data about Splunk Indexes configured in your environment.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/data/indexes",
        "uri_query": {
            'output_mode': 'json'
        },
    ...
    modinput = modinput_ninja("ninja_indexes", INPUT_SCHEME_JSON, vars)
