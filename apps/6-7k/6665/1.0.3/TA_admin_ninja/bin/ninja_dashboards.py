...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Dashboards",
    "description": "Get data from Splunk Dashboards (Classic or Dashboard Studio) in your environment.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/data/ui/views",
        "uri_query": {
            'output_mode': 'json'
        },
    ...
    modinput = modinput_ninja("ninja_dashboards", INPUT_SCHEME_JSON, vars)
