...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: HEC Tokens",
    "description": "Get data about Splunk HEC Tokens configured in your environment.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/data/inputs/http",
        "uri_query": {
            'output_mode': 'json'
        },
    ...
    modinput = modinput_ninja("ninja_hec_tokens", INPUT_SCHEME_JSON, vars)
