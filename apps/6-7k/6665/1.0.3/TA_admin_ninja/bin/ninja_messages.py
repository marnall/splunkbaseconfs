...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Messages",
    "description": "Get data from alerts and messages occurring across your Splunk Environment.",
...
if __name__ == "__main__":
    ...
    modinput = modinput_ninja("ninja_messages", INPUT_SCHEME_JSON, vars)
