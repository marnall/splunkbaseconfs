...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Macros",
    "description": "Get data from Splunk Macros defined in your environment.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/admin/macros",
        "uri_query": {
            'output_mode': 'json',
            'f': [
                'definition',
    ...
    modinput = modinput_ninja("ninja_macros", INPUT_SCHEME_JSON, vars)
