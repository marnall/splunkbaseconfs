...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Deployment Clients",
    "description": "Get data about Splunk Deployment Clients reporting to your deployment server.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/deployment/server/clients",
        "uri_query": {
            'output_mode': 'json'
        },
    ...
    modinput = modinput_ninja("ninja_ds_clients", INPUT_SCHEME_JSON, vars)
