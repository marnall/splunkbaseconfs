...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: DS Serverclasses",
    "description": "Get data from serverclasses configured on your Deployment Server.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/deployment/server/serverclasses",
        "uri_query": {
            'output_mode': 'json'
        },
    ...
    modinput = modinput_ninja("ninja_ds_serverclasses", INPUT_SCHEME_JSON, vars)
