...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Disk Partitions",
    "description": "Get data about the Disk Partitions Splunk is mounted on.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/server/status/partitions-space",
        "uri_query": {
            'output_mode': 'json'
        },
    ...
    modinput = modinput_ninja("ninja_partitions", INPUT_SCHEME_JSON, vars)
