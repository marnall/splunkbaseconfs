...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Datamodels",
    "description": "Get data from Splunk Datamodels configured in your environment.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/datamodel/model",
        "uri_query": {
            'output_mode': 'json',
            'f': [ 
                'acceleration', 
    ...
    modinput = modinput_ninja("ninja_datamodels", INPUT_SCHEME_JSON, vars)
