...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Calculated Fields",
    "description": "Get data about configured Calculated Fields in your environment.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/data/props/calcfields",
        "uri_query": {
            'output_mode': 'json'
        },
    ...
    modinput = modinput_ninja("ninja_calcfields", INPUT_SCHEME_JSON, vars)
