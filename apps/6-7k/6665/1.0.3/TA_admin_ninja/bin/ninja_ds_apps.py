...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Deployment Server Apps",
    "description": "Get data about deployment apps deployed from your deployment servers.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/deployment/server/applications",
        "uri_query": {
            'output_mode': 'json'
        },
    ...
    modinput = modinput_ninja("ninja_ds_apps", INPUT_SCHEME_JSON, vars)
