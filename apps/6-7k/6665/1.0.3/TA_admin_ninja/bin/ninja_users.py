...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Users",
    "description": "Get data about Splunk Users created in your environment.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/authentication/users",
        "uri_query": {
            'output_mode': 'json'
        },
    ...
    modinput = modinput_ninja("ninja_users", INPUT_SCHEME_JSON, vars)
