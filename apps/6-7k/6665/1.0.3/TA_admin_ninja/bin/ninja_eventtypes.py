...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Eventtypes",
    "description": "Get data from Splunk Eventtypes configured in your environment.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/saved/eventtypes",
        "uri_query": {
            'output_mode': 'json'
        },
    ...
    modinput = modinput_ninja("ninja_eventtypes", INPUT_SCHEME_JSON, vars)
