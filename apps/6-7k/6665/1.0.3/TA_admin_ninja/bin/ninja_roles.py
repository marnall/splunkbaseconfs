...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Roles",
    "description": "Get data about Splunk Roles being used in your environment.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/authorization/roles",
        "uri_query": {
            'output_mode': 'json'
        },
    ...
    modinput = modinput_ninja("ninja_roles", INPUT_SCHEME_JSON, vars)
