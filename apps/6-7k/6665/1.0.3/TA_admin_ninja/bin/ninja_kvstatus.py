...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: KV Store Status",
    "description": "Get the current status/health of the KV Store on your Splunk install.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/kvstore/status",
        "uri_query": {
            'output_mode': 'json'
        },
    ...
    modinput = modinput_ninja("ninja_kvstatus", INPUT_SCHEME_JSON, vars)
