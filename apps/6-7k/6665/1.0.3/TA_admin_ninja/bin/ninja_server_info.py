...
INPUT_SCHEME_JSON = {
    "title": "Admin Ninja: Server Info",
    "description": "Get server and architecture info about Splunk instances your environment.",
...
if __name__ == "__main__":
    ...
    vars = {
        "uri_path": "/servicesNS/-/-/server/info",
        "uri_query": {
            'output_mode': 'json'
        },
    ...
    modinput = modinput_ninja("ninja_server_info", INPUT_SCHEME_JSON, vars)
