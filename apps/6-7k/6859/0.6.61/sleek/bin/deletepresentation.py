...
class DeletePresentation(PersistentServerConnectionApplication):
    ...
    def handle(self, in_string):
        ...
        prezID = args['query_parameters']["id"]

        if os.path.exists(os.path.join(os.environ['SPLUNK_HOME'],'etc','apps','sleek','appserver','static','presentations',prezID)) :
            os.remove(os.path.join(os.environ['SPLUNK_HOME'],'etc','apps','sleek','appserver','static','presentations',prezID))
