    ...
    def validate(self, value, data):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                msg = "Vectra XDR validation: Account with Host Name - {} " \
            ...
            logger.error(
                "Vectra XDR validation: SSL Error occurred while validating "
                "Vectra XDR account: {}\n{}"
            ...
            logger.error(
                "Vectra XDR validation: Proxy Error occurred while validating "
                "Vectra XDR account: {}\n{}"
            ...
            if "response" in locals() and response.status_code == 401:
                ...
                msg = "Server error: Status code - {}. " \
                    "Cannot verify Vectra XDR instance. " \
                ...
                msg = "Unexpected error occurred. Please verify the Host Name " \
                    "and check `ta_vectra_xdr_account_validation.log` file for " \
                    "more details."

            self.put_msg(msg)
            logger.error("Vectra XDR validation: Error occurred while "
                         "validating Vectra XDR account: {}\n{}"
