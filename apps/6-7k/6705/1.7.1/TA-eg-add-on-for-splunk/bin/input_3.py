...
import input_module_input_3 as input_module
...
'''
    ...
    Add your modular input logic to file input_module_input_3.py
'''
class ModInputinput_3(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputinput_3, self).__init__("ta_eg_add_on_for_splunk", "input_3", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputinput_3, self).get_scheme()
        scheme.title = ("Input_3")
...
if __name__ == "__main__":
    exitcode = ModInputinput_3().run(sys.argv)
    sys.exit(exitcode)
