...
import input_module_showtests as input_module
...
'''
    ...
    Add your modular input logic to file input_module_showtests.py
'''
class ModInputshowtests(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputshowtests, self).__init__("ta_eg_add_on_for_splunk", "showtests", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputshowtests, self).get_scheme()
        scheme.title = ("showtests")
...
if __name__ == "__main__":
    exitcode = ModInputshowtests().run(sys.argv)
    sys.exit(exitcode)
