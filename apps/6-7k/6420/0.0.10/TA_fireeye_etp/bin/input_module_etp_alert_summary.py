...
ETP_SERVICE_REGION = ('etp.us.fireeye.com', 'etp.eu.fireeye.com', 'etp.ap.fireeye.com', 'etp.us.fireeyegov.com')
...
def collect_events(helper, ew):
    ...
    global_fireeye_api_key = helper.get_global_setting("fireeye_api_key")
    ...
    if state is None and opt_from_last_modified_on is not None:
        state = opt_from_last_modified_on

    if state is None and opt_from_last_modified_on is None:
    ...
    headers = {
        ...
        'x-fireeye-api-key': global_fireeye_api_key
    }
