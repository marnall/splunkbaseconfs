...
# Installation
1. Create an OAuth Token (API Key) on FireEye Cloud
    - https://console.us.fireeye.com/console/settings/user/apiKeys
    - [Configuring API keys](https://docs.trellix.com/ja-JP/bundle/etp_2022-4_api/page/UUID-afd25205-aa8d-2641-a67a-9fac320c3c3f_1.html#idm45998023324480)
    - Required entitlements
        - etp.alerts.read
        - etp.email_trace.read
2. Go to TA FireEye ETP App
    - Apps -> TA FireEye ETP -> Configuration -> Add-on Settings
3. Select the region instance and set the OAuth Token.

# Configuration of Add-on Settings
|  Fileds  | Description | 
| ----     | ---- | 
|  FireEye API Key | - Set your API key | 
|  ETP Service Region  | - Set your ETP Reagion. |
|  SSL Verify Enable  | - If checked, this app verifies SSL certificates for every HTTPS requests |
...
|  Time Lag Guard  |  - There is a time lag between last modified timestamp of a data and DB insertion timestamp of a data on FireEye. <br> - This option is for the lag.<br> - Recommend to set `5~10` minutes. If 5 is set, this input fetch the data until about 5 minutes ago.  |
...
- [Access control](https://docs.trellix.com/ja-JP/bundle/etp_2022-4_api/page/UUID-afd25205-aa8d-2641-a67a-9fac320c3c3f_3.html#idm45998022582048)
