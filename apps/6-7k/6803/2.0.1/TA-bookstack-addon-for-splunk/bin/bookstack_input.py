...
def get_account_api_key(session_key: str, account_name: str):
    cfm = conf_manager.ConfManager(
        session_key,
        ADDON_NAME,
        realm=f"__REST_CREDENTIAL__#{ADDON_NAME}#configs/conf-ta_bookstack_addon_for_splunk_account",
    )
    account_conf_file = cfm.get_conf("TA-bookstack-addon-for-splunk_account")
...
class Input(smi.Script):
    ...
    def get_scheme(self):
        scheme = smi.Scheme("bookstack_input")
        scheme.description = "bookstack_input input"
