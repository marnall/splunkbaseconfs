...
class Input(smi.Script):
    ...
    def get_scheme(self):
        ...
        scheme = smi.Scheme("dataminr_webhook")
        scheme.description = "dataminr_webhook input"
        ...
        scheme.add_argument(smi.Argument("lists_names", title="List Names",
                                         ...
                                         required_on_create=True,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("hec_token", title="Collect Related Alerts",
                                         description="Check the checkbox if you want to collect Related Alerts too.",
                                         required_on_create=True,
                                         required_on_edit=True))
        scheme.add_argument(smi.Argument("dataminr_webhook_id", title="Collect Related Alerts",
                                         description="Check the checkbox if you want to collect Related Alerts too.",
