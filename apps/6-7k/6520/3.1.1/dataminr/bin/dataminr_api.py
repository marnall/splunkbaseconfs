...
from dataminr_alerts_collector import DataminrAlertsCollector
...
class Input(smi.Script):
    ...
    def get_scheme(self):
        ...
        scheme = smi.Scheme("dataminr_api")
        scheme.description = "dataminr_api input"
    ...
    def stream_events(self, inputs: smi.InputDefinition, event_writer: smi.EventWriter):
        ...
        dm_collector = DataminrAlertsCollector(inputs, event_writer)
