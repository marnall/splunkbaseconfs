...
import app_aws_security_bin.utils.app_util as util
...
def _load_custom_rules():
    ...
    ##Syntax
    .. code-block::
        awssecurityuseragent (prefix=string)? (device=bool)? (os=bool)? (ua=bool)? user-agent-fieldname
    ##Description
    ...
    .. code-block::
        ... | awssecurityuseragent prefix=my_ua_ device=f os=f ua_from_js
    """
prefix = Option(
        doc='''
