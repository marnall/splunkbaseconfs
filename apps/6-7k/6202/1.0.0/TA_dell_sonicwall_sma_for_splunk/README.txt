...
This app provides field extraction, cim mapping(network, authentication) for Dell SonicWall Secure Mobile Access(SMA) in Splunk.
...
Configure the input sourcetype as dell:sonicwall:sma.
