...
This application indexes RSS headlines from the NHL and ESPN NHL.
It also shows embedded web pages for NHL and the Bleacher Report NHL in the
...
Make sure that rss_nhl.sh and rss_espn_nhl.sh in the bin directory can
