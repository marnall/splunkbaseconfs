# Author: Nimish Doshi
# This file is used to encrypt data (group 1 in regex) within a file per line
...
if len(sys.argv) < 3:
    print ('Usage: python encryptfield.py filename escaped-regex key')
    sys.exit()
...
for line in file:
    ...
    if mymatch:
        ...
        printdata = base64.b64encode(data)
