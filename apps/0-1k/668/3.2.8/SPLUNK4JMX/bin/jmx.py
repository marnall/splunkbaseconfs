...
def run_java(config_xml=None):
    ...
    java_args = [ JAVA_EXECUTABLE,"-Xbootclasspath/a:"+BOOTPATH, "-classpath",CLASSPATH,"-Xms"+MIN_HEAP,"-Xmx"+MAX_HEAP,"-Dconfighome="+CONFIG_HOME,"-DSPLUNK_HOME="+SPLUNK_HOME,"-DSPLUNKD_TIMEOUT_SECS="+SPLUNKD_TIMEOUT_SECS,"-Dsplunk.securetransport.protocol="+SECURE_TRANSPORT,JAVA_MAIN_CLASS]
