...
* Version : 3.2.8
* Date : January 2026
* Author : BaboonBones Ltd , www.baboonbones.com
...
* bin/lib/json.jar
* bin/lib/jmxmodinput.jar
* bin/lib/commons-logging-1.1.1.jar
* bin/lib/commons-discovery-0.2.jar
* bin/lib/httpclient-4.4.1.jar
* bin/lib/lin/tools-lin.jar
* bin/lib/activation-1.1.1.jar
* bin/lib/castor-1.3-core.jar
* bin/lib/mx4j-tools.jar
* bin/lib/win/tools-win.jar
* bin/lib/wsdl4j.jar
...
* bin/lib/mx4j_boot/mx4j-remote.jar
* bin/lib/mx4j_boot/mx4j.jar
* bin/lib/castor-1.3-xml.jar
* bin/lib/istack-commons-runtime-3.0.10.jar
* bin/lib/xercesImpl.jar
* bin/lib/hessian-3.0.8.jar
...
* Browse to the `Setup Credentials` menu tab and setup JMX username(s)/password(s).
* Encrypted credentials are saved to `$SPLUNK_HOME/etc/apps/SPLUNK4JMX/local/passwords.conf`
* Enter your Activation Key , see below
* Setup your `config.xml` file , see below.
* Browse to the `Data Inputs` menu tab and setup your JMX Inputs.
...
In this case, the "host", "jmxport", "jmxuser" attributes will not be used.
...
* look for errors in the log files or via the Logs menu item in the App's navigation bar
...
* Run this command as the same user that you are running Splunk as and observe console output : `$SPLUNK_HOME/bin/splunk cmd python ../etc/apps/SPLUNK4JMX/bin/jmx.py --scheme` 
