...
define(
    ...
    function(Backbone, jquery, splunk_js_sdk) {
        ...
        var SetupView = Backbone.View.extend({
            ...
            events: {
                "click .setup_checkbox": "trigger_setup",
            },
            ...
            fetchDefaultUiValues: async function() {
                ...
                let endpoint_input_element = jquery("input[name=setup_checkbox]");
                if (props.is_configured == 1){
                  endpoint_input_element.prop("checked",true);
                }
            },
            ...
            perform_setup: async function perform_setup(splunk_js_sdk) {
                ...
                try {
                    ...
                    alert("Setup page will no longer be shown.");
                    await this.redirect_to_splunk_app_homepage(app_name);
                } catch (error) {
            ...
            get_template: function get_template() {
                template_string =
                    "<div class='checkbox'>" +
                    " <label> " +
                    "<input name='setup_checkbox'  class='setup_checkbox' type='checkbox' id='setup_checkbox'>Do not show again!" +
                    " </label> " +
                    "        </div>" +
                    "        <br/>" +
