...
This application is intended to run on a Splunk Indexer (or Heavy
Forwarder) and receive raw data with Splunk meta data from the
Splunk Diode Sender app.
...
traffic type and listening port need to match the sender Add-On.
