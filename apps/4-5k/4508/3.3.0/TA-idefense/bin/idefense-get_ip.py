"""
Query idefense IP api with provided params.

Usage in Splunk -> |iDefenseGetIp <optional args, kwargs>
...
@Configuration()
class iDefenseGetIp(GeneratingCommand):
    ...
    def generate(self):
        self.idefense_search.queryiDefense(self.service, "ip")
...
if __name__ == '__main__':
    ...
    dispatch(iDefenseGetIp, sys.argv, sys.stdin, sysout, __name__)
