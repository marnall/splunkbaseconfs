...
class RemoveJob(PersistentServerConnectionApplication):
    ...
    def handle(self, in_string):
        ...
        remove = open(results_file,"w")
        #remove.write("job_id,request_id,status,app_name,error,failure,skipped,manual_check,not_applicable,warning,success,appid,app_path\n")
