...
if __name__ == '__main__':
    ...
    eStart = time.time()
    try:
        keywords = filter(lambda x: not re.findall("^\w+=|scma_check.py$", x), sys.argv)
        ...
        rest_uri = '/servicesNS/-/scma/configs/conf-checklist?output_mode=json&count=-1&search=disabled%3Dfalse%20eai%3Aacl.app%3Dscma%20category%3D"1%20-%20Splunk%20Cloud%20Migration%20Assessment"'
