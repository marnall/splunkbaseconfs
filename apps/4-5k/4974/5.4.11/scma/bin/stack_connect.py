...
class Stack_Connect(PersistentServerConnectionApplication):
    ...
    def handle(self, in_string):
        ...
        response = requests.get(acs_url+stackname+'/adminconfig/v2/status', headers=headers, verify=False)  # nosemgrep
        ...
        if response.status_code == 404 :
            ...
            response = requests.get("https://"+stackname+rest_url+apav_endpoint+"?output_mode=json", headers=headers, verify=False)  # nosemgrep
