...
class GetSummary(PersistentServerConnectionApplication):
    ...
    def handle(self, in_string):
        ...
        report = args['form_parameters']["report"]

        report_path = os.path.join(reports_folder,report+".html")

        f = open(report_path,"r")

        htmlcontent = f.read()
        return {'payload': htmlcontent, 'status': 200}
