...
- Added support to Sonar external users (e.g.: SAML/LDAP)
- Sonar Splunk app now uses splunk-ui toolkit

## [3.1.3] - 2021-12-01

### Bug Fixes

- Update license read permissions. 
Users with a minimum set of capabilities are now able to query using sonar custom command. 
