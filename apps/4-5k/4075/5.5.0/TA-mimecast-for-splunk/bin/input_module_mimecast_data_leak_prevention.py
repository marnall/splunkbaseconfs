...
def validate_input(helper, definition):
    ...
    # actions = definition.parameters.get('actions', None)
...
def collect_events(helper, ew):
    ...
    opt_actions = helper.get_arg('actions')
    ...
    opt_actions = helper.get_arg('actions', stanza_name)
    ...
    api.fetch_data_leak_prevention_logs()
