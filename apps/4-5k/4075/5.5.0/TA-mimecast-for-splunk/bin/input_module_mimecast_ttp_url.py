...
def validate_input(helper, definition):
    ...
    # logs_to_fetch = definition.parameters.get('logs_to_fetch', None)
...
def collect_events(helper, ew):
    ...
    opt_logs_to_fetch = helper.get_arg('logs_to_fetch')
    ...
    opt_logs_to_fetch = helper.get_arg('logs_to_fetch', stanza_name)
