...
import input_module_pihole_system as input_module
...
'''
    ...
    Add your modular input logic to file input_module_pihole_system.py
'''
class ModInputpihole_system(modinput_wrapper.base_modinput.BaseModInput):
...
if __name__ == "__main__":
    exitcode = ModInputpihole_system().run(sys.argv)
    sys.exit(exitcode)
