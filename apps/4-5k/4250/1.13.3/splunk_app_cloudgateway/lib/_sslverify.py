## This file has been slightly modified from source to use sha356 instead of md5 in sessionName generation
...
class ClientTLSOptions(object):
    ...
    def clientConnectionForTLS(self, tlsProtocol):
        ...
        """
        connection = SSL.Connection(SSL.Context(SSL.TLSv1_2_METHOD), None)
...
class OpenSSLCertificateOptions(object):
    ...
    def _makeContext(self):
        ...
        if self.enableSessions:
            ...
            # sessionName changed to use sha256 hash to support fips mode
            sessionName = sha256(networkString(name)).hexdigest()[0:32]
