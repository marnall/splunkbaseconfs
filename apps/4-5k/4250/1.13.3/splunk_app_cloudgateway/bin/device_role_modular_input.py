...
class DeviceRolesMappingModularInput(modular_input.ModularInput):
    """
    """
    title = 'Splunk Cloud Gateway Role Based Notification Manager'
    ...
    logger = setup_logging(SPACEBRIDGE_APP_NAME + '_modular_input.log', 'device_role_mapping.app')
    ...
    def do_run(self, input_config):
        ...
        try:
            ...
            task.react(update, [self.session_key, kvstore_client, splunk_client])
