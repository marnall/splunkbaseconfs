...
def setup_logger():
    ...
    file_handler = logging.handlers.RotatingFileHandler(os.environ['SPLUNK_HOME'] + '/var/log/splunk/'+logFileName+'.log', maxBytes=25000000, backupCount=5)
...
class ConfigApp(admin.MConfigHandler):
    ...
    def handleList(self, confInfo):
        ...
        if response.status_code == 200:
            ...
            cfm_inputs_conf.update(stanza, {"access_token": content["access_token"], "refresh_token": content["refresh_token"], "clientSecret": clientSecret,"proxy_password": proxyPassword,"expiry_time": expiryTime}, ['access_token', 'refresh_token', 'clientSecret', 'proxy_password'])
