...
if __name__ == '__main__':
    ...
    try:
        ...
        if EIQ_VERSION == "FC" or EIQ_VERSION == "Fusion" or EIQ_VERSION == "Fc-essentials":
        ...
        for k in result:
            ...
            if sighting_type in filtered_types_list:
                api.create_entity(record, SOURCEGROUPNAME, entity_title, entity_description)
                ...
                script_logger.error('Sighting of {0} {1}'.format(sighting_type, sighting_value) +
