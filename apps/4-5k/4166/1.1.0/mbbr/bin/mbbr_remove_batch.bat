...
::------------------------------------------------------------------------------------------------------------
SET scanparms=-threat        -stdout:summary -pfi:10 -remove
REM SET scanparms=-threat -stdout:summary -pfi:30 -remove
REM SET scanparms=-threat -stdout:summary -pfi:10 -remove
...
:: CHANGES
:: 2019-03-05 V0.9.37
::   Added indicators of compromise reference and settings.  Tidied exclusion logic.
::
:: 2019-02-07 V0.9.36
