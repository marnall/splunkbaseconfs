...
class GetRawFileCopyUtility64(PersistentServerConnectionApplication):
    ...
    def handle(self, requestIn):
        ...
        try:
            ...
            return {'payload': Perseus_Utility_File_Repo.getUtilityFileKvStoreEntryByKey("3c78b096-236f-4b0c-9076-9a7ac1080164", headerAuth),
                    'status': 200
                   }
