...
import input_module_azure_compute as input_module
...
'''
    ...
    Add your modular input logic to file input_module_azure_compute.py
'''
class ModInputazure_compute(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputazure_compute, self).__init__("ta_azure_inventory", "azure_compute", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputazure_compute, self).get_scheme()
        scheme.title = ("Compute")
...
if __name__ == "__main__":
    exitcode = ModInputazure_compute().run(sys.argv)
    sys.exit(exitcode)
