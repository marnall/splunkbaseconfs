...
import input_module_azure_security_center as input_module
...
'''
    ...
    Add your modular input logic to file input_module_azure_security_center.py
'''
class ModInputazure_security_center(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputazure_security_center, self).__init__("ta_azure_inventory", "azure_security_center", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputazure_security_center, self).get_scheme()
        scheme.title = ("Security Center")
...
if __name__ == "__main__":
    exitcode = ModInputazure_security_center().run(sys.argv)
    sys.exit(exitcode)
