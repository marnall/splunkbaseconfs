...
import input_module_azure_topology_manual as input_module
...
'''
    ...
    Add your modular input logic to file input_module_azure_topology_manual.py
'''
class ModInputazure_topology_manual(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputazure_topology_manual, self).__init__("ta_azure_inventory", "azure_topology_manual", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputazure_topology_manual, self).get_scheme()
...
if __name__ == "__main__":
    exitcode = ModInputazure_topology_manual().run(sys.argv)
    sys.exit(exitcode)
