...
import input_module_azure_virtual_networks as input_module
...
'''
    ...
    Add your modular input logic to file input_module_azure_virtual_networks.py
'''
class ModInputazure_virtual_networks(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputazure_virtual_networks, self).__init__("ta_azure_inventory", "azure_virtual_networks", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputazure_virtual_networks, self).get_scheme()
        scheme.title = ("Virtual Networks")
        ...
        scheme.add_argument(smi.Argument("subscription_id", title="Subscription ID",
                                         ...
                                         required_on_create=True,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("collect_virtual_networks_data", title="Collect Virtual Networks Data",
                                         description="",
    ...
    def get_checkbox_fields(self):
        checkbox_fields = []
        checkbox_fields.append("collect_virtual_networks_data")
...
if __name__ == "__main__":
    exitcode = ModInputazure_virtual_networks().run(sys.argv)
    sys.exit(exitcode)
