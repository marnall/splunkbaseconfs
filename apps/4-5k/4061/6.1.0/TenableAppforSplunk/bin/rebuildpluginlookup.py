...
class RebuildPluginLookup(GeneratingCommand):
    ...
    def generate(self):
        self.logger.info('delete: {}'.format(self.delete))
        data = self.service.saved_searches.get('Tenable SC Plugin Data')
...
dispatch(RebuildPluginLookup, sys.argv, sys.stdin, sys.stdout, __name__)
