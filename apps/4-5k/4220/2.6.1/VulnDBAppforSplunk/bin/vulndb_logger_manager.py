...
def get_log_level(session_key):
    ...
    conf_endpoint = "/servicesNS/nobody/{}/configs/conf-ta_vuln_db_settings/logging".format(__file__.split(os.sep)[-3])
    _, content = rest.simpleRequest(
        conf_endpoint, method='GET', sessionKey=session_key, getargs={"output_mode": "json"}, raiseAllErrors=True)
