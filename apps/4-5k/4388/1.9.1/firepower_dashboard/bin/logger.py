...
def setup_logging(logger_name = None, log_file = None):
    ...
    splunk_log_handler = logging.handlers.RotatingFileHandler(os.path.join(SPLUNK_HOME, BASE_LOG_PATH, log_file),
...
def main():
    global logger
    logger = setup_logging('firepower_logger', 'firepower.log')
