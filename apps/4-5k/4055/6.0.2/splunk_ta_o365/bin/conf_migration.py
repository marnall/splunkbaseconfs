...
def get_splunkd_info(session_key):
    splunkd_info = urlparse(get_splunkd_uri(session_key=session_key))
    return splunkd_info
...
class ConfMigration:
    ...
    def run(self):
        ...
        self._splunkd_info = get_splunkd_info(session_key=self._session_key)
