...
* Updated the time field for SC Vuln data.

## Version 8.0.1

* Fixed SC Custom SSL Certificate issue.
* Improved compliance data collection by preserving original fields.
...
# Upgrading to version 8.0.2

Follow the below steps to upgrade the Add-on to 8.0.2

* Disable all the inputs from the Inputs page of Tenable Add-on for Splunk.
* Install the Tenable Add-on for Splunk v8.0.2
