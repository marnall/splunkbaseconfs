...
def collect_events(helper, ew):
    ...
    """
    dellecs_obj = DellECSCollect(helper, ew, input_type="bucket")
    ...
    try:
        ...
        helper.log_error("Traceback for Bucket Endpoints: {}".format(traceback.format_exc()))

    try:
        dellecs_obj.handle_dependent_endpoint_conf_api()
    except Exception as e:
        helper.log_error(str(e))
        helper.log_error("Traceback for Dependent Bucket Endpoints: {}".format(traceback.format_exc()))
