...
entity = splunk.entity.getEntity('/server','settings', namespace='Splunk_Essentials_For_Wire_Data', sessionKey=sessionKey, owner='-')
mydict = dict()
mydict = entity
...
request = urllib2.Request(base_url + '/servicesNS/nobody/Splunk_Essentials_For_Wire_Data/storage/collections/data/bookmark',
...
myApps = ["Splunk_Essentials_For_Wire_Data"]
