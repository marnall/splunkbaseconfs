...
Splunk itself sends some usage data (again, if you've opt'd in). Splunk Essentials for ICS Security and Compliance doesn't touch that stuff, but you can go read about it here: https://docs.splunk.com/Documentation/Splunk/latest/Admin/Shareperformancedata
