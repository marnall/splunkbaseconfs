...
def collect_events(helper, ew):
    ...
    opt_offset = Offset(datetime.datetime.now()-datetime.timedelta(seconds=1800))
    ...
    partCount = partitions.get('partition_count')

    for part in range(0, partCount):
        opt_partition = part
        ...
        try:
            ...
            for event_data in receiver.receive(timeout=30):
