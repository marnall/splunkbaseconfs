...
from ipinfo.bundles import PlusBundle
...
@Configuration()
class IPinfoPlusCommand(StreamingCommand):
...
dispatch(IPinfoPlusCommand, sys.argv, sys.stdin, sys.stdout, __name__)
