...
from ipinfo.bundles import CoreBundle
...
@Configuration()
class IPinfoCoreCommand(StreamingCommand):
    ...
    def prepare(self):
        ...
        except (MMDBNotFoundException, InvalidPrefixException, APITokenNotFoundException) as exc:
...
dispatch(IPinfoCoreCommand, sys.argv, sys.stdin, sys.stdout, __name__)
