...
from ipinfo.bundles import LiteBundle
...
@Configuration()
class IPinfoLiteCommand(StreamingCommand):
...
dispatch(IPinfoLiteCommand, sys.argv, sys.stdin, sys.stdout, __name__)
