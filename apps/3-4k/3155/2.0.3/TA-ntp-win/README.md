...
Detailed documentation, including installation, troubleshooting and release notes, is available online in [PDF format](https://github.com/thatfrankwayne/TA-ntp-win/blob/main/docs/ntp_statistics_add-on_for_splunk_2.0.1.pdf).
