 [![N|Solid](https://www.geminidata.com/img/logos/logo-gemini.svg)](http://www.geminidata.com/)
...
## Building
To build a new .spl distribution of the app, simply run gradle:

> ./gradlew createDist

That will create a new .spl file under build/distributions.

Before submitting that dist, make sure to run the pre-certification check and that there are no errors or warnings:
