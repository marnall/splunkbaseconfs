...
if is_windows:
    TA_APP = SPLUNK_HOME + '\\etc\\apps\\TA-metricator-for-nmon'
else:
    TA_APP = SPLUNK_HOME + '/etc/apps/TA-metricator-for-nmon'

if is_windows:
    TA_APP_CLUSTERED = SPLUNK_HOME + '\\etc\\peer-apps\\TA-metricator-for-nmon'
else:
    TA_APP_CLUSTERED = SPLUNK_HOME + '/etc/peer-apps/TA-metricator-for-nmon'
...
# Set output file
config_output = CONFIG_DIR + HOSTNAME + '_' + minute + '_' + section + '.events.csv'
...
def multi_dimension_metrics_fn(section):
    ...
    currsection_output = DATA_DIR + HOSTNAME + '_' + minute + '_' + section + '.metrics.csv'
...
def multi_dimension_events_fn(section):
    ...
    # for output file
    currsection_output = DATA_DIR + HOSTNAME + '_' + minute + '_' + section + '.events.csv'
        ...
        for line in data:
            ...
            if oslevel == 'Linux':  # Linux OS specific header
                ...
                if perfdata_match:
                    ...
                    # Write perf data
                    membuffer.write(
                        section + ',' + SN + ',' + HOSTNAME + ',' + OStype + ',' + ZZZZ_timestamp + ',' +
                        perfdata + '\n'),
