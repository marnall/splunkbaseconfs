...
This addon was built from the [Kintyre Splunk App builder](https://github.com/Kintyre/cypress-cookiecutter) (version 1.11.5) [cookiecutter](https://github.com/audreyr/cookiecutter) project.
