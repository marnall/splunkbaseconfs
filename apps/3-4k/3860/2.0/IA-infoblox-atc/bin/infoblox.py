...
_MI_APP_NAME = 'Infoblox BloxOne Threat Defense Modular Input'
...
MI = infoblox(_APP_NAME, {
    ...
    "args": [
        {"name": "tenanturl",
         "description": "The Infoblox BloxOne Threat Defense URL. For production: csp.infoblox.com",
         "title": "Tenant URL",
         "required": True
         },
        {"name": "token",
         "description": "The Authorization Token generated by Infoblox",
         "title": "Token"
         },
        {"name": "t0",
...
def KVToString(eventDict):
    ev_dict = eventDict
    kv_pairs = ", ".join("{}={}".format(k, json.dumps(v)) for k, v in list(ev_dict.items()))
    return kv_pairs
...
def run():
    ...
    try:
        ...
        for evt_type in evts:
            ...
            if isinstance(chk, float) or isinstance(chk, int) :
                oldchk = chk
            ...
            atc_ga = int((datetime(2016, 12, 24, 0, 0) - datetime(1970,1,1)).total_seconds())  # ATC 1.0 GA
