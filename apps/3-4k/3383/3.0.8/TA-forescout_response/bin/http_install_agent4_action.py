...
## Setup the logger
logger = CounterACTBaseAction.setup_logger('http_install_agent4_action_modalert')
...
if __name__ == "__main__":
	...
	modaction = CounterACTAdaptiveResponseTestAction(sys.stdin.read(), logger, 'http_install_agent4_action')
	try:
