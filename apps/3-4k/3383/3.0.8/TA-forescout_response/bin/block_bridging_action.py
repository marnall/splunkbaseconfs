...
## Setup the logger
logger = CounterACTBaseAction.setup_logger('block_bridging_action_modalert')
...
if __name__ == "__main__":
	...
	modaction = CounterACTAdaptiveResponseTestAction(sys.stdin.read(), logger, 'block_bridging_action')
	try:
