...
## Setup the logger
logger = CounterACTBaseAction.setup_logger('adaptive_response_test_action_modalert')
...
if __name__ == "__main__":
	...
	modaction = CounterACTAdaptiveResponseTestAction(sys.stdin.read(), logger, 'adaptive_response_test_action')
	try:
