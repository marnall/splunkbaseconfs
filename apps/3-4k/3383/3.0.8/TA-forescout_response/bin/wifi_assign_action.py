...
## Setup the logger
logger = CounterACTBaseAction.setup_logger('wifi_assign_action_modalert')
...
if __name__ == "__main__":
	...
	modaction = CounterACTAdaptiveResponseTestAction(sys.stdin.read(), logger, 'wifi_assign_action')
	try:
