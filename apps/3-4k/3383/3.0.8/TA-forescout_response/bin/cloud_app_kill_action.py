...
## Setup the logger
logger = CounterACTBaseAction.setup_logger('cloud_app_kill_action_modalert')
...
if __name__ == "__main__":
	...
	modaction = CounterACTAdaptiveResponseTestAction(sys.stdin.read(), logger, 'cloud_app_kill_action')
	try:
