...
## Setup the logger
logger = CounterACTBaseAction.setup_logger('agent_shut_down_action_modalert')
...
if __name__ == "__main__":
	...
	modaction = CounterACTAdaptiveResponseTestAction(sys.stdin.read(), logger, 'agent_shut_down_action')
	try:
