...
## Setup the logger
logger = CounterACTBaseAction.setup_logger('http_localhost_login_action_modalert')
...
if __name__ == "__main__":
	...
	modaction = CounterACTAdaptiveResponseTestAction(sys.stdin.read(), logger, 'http_localhost_login_action')
	try:
