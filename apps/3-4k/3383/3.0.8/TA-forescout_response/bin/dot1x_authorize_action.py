...
## Setup the logger
logger = CounterACTBaseAction.setup_logger('dot1x_authorize_action_modalert')
...
if __name__ == "__main__":
	...
	modaction = CounterACTAdaptiveResponseTestAction(sys.stdin.read(), logger, 'dot1x_authorize_action')
	try:
