...
## Setup the logger
logger = CounterACTBaseAction.setup_logger('virtual-fw-rule_action_modalert')
...
if __name__ == "__main__":
	...
	modaction = CounterACTAdaptiveResponseTestAction(sys.stdin.read(), logger, 'virtual-fw-rule_action')
	try:
