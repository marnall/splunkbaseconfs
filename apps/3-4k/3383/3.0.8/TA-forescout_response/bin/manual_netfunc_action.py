...
## Setup the logger
logger = CounterACTBaseAction.setup_logger('manual_netfunc_action_modalert')
...
if __name__ == "__main__":
	...
	modaction = CounterACTAdaptiveResponseTestAction(sys.stdin.read(), logger, 'manual_netfunc_action')
	try:
