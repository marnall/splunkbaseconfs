...
## Setup the logger
logger = CounterACTBaseAction.setup_logger('sendmailtohost_ad_mail_action_modalert')
...
if __name__ == "__main__":
	...
	modaction = CounterACTAdaptiveResponseTestAction(sys.stdin.read(), logger, 'sendmailtohost_ad_mail_action')
	try:
