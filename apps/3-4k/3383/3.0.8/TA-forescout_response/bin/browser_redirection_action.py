...
## Setup the logger
logger = CounterACTBaseAction.setup_logger('browser_redirection_action_modalert')
...
if __name__ == "__main__":
	...
	modaction = CounterACTAdaptiveResponseTestAction(sys.stdin.read(), logger, 'browser_redirection_action')
	try:
