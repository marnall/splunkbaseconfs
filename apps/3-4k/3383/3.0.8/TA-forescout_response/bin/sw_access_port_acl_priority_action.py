...
## Setup the logger
logger = CounterACTBaseAction.setup_logger('sw_block_action_modalert')
...
if __name__ == "__main__":
	...
	modaction = CounterACTAdaptiveResponseTestAction(sys.stdin.read(), logger, 'sw_access_port_acl_priority_action')
	try:
