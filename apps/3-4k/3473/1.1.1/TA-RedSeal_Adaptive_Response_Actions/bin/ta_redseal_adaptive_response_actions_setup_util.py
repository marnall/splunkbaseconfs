...
import ta_redseal_adaptive_response_actions_consts as setup_const
...
class Setup_Util(object):
    ...
    def _parse_conf_from_rest(self):
        conf_mgr = conf.ConfManager(
            self.__session_key, "TA-RedSeal_Adaptive_Response_Actions", scheme=self.scheme, host=self.host, port=self.port)
