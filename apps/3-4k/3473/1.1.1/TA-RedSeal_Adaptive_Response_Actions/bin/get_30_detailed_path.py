...
import modalert_get_30_detailed_path_helper

class AlertActionWorkerget_30_detailed_path(ModularAlertBase):

    def __init__(self, ta_name, alert_name):
        super(AlertActionWorkerget_30_detailed_path, self).__init__(ta_name, alert_name)
    ...
    def process_event(self, *args, **kwargs):
        ...
        try:
            ...
            if not self.validate_params():
                return 3 
            status = modalert_get_30_detailed_path_helper.process_event(self, *args, **kwargs)
...
if __name__ == "__main__":
    exitcode = AlertActionWorkerget_30_detailed_path("TA-RedSeal_Adaptive_Response_Actions", "get_30_detailed_path").run(sys.argv)
    sys.exit(exitcode)
