...
import modalert_get_20_incident_response_helper

class AlertActionWorkerget_20_incident_response(ModularAlertBase):

    def __init__(self, ta_name, alert_name):
        super(AlertActionWorkerget_20_incident_response, self).__init__(ta_name, alert_name)
    ...
    def process_event(self, *args, **kwargs):
        ...
        try:
            ...
            if not self.validate_params():
                return 3 
            status = modalert_get_20_incident_response_helper.process_event(self, *args, **kwargs)
...
if __name__ == "__main__":
    exitcode = AlertActionWorkerget_20_incident_response("TA-RedSeal_Adaptive_Response_Actions", "get_20_incident_response").run(sys.argv)
    sys.exit(exitcode)
