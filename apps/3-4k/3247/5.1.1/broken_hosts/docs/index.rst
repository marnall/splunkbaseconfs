...
- Declares ``python.required`` in ``restmap.conf`` for the setup REST handler, resolving the Splunk AppInspect ``check_admin_external_restmap_conf_python_required`` check for Splunk 10 compatibility. Supports Python 3.9 and 3.13.
