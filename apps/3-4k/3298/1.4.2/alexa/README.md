# Talk to Splunk with Amazon Alexa v1.4.2
...
* bin/lib/jackson-databind-2.3.2.jar
* bin/lib/jackson-core-2.3.2.jar
* bin/lib/jaxb-runtime-2.3.2.jar
* bin/lib/json.jar
* bin/lib/jetty-io-9.0.6.v20130930.jar
* bin/lib/jsoup-1.8.3.jar
* bin/lib/jetty-security-9.0.6.v20130930.jar
* bin/lib/httpclient-4.4.1.jar
* bin/lib/activation-1.1.1.jar
* bin/lib/alexa-skills-kit-1.1.1.jar
* bin/lib/commons-logging-1.1.3.jar
* bin/lib/jetty-servlet-9.0.6.v20130930.jar
* bin/lib/splunk_tlsv12.jar
* bin/lib/log4j-1.2.17.jar
* bin/lib/log4j-1.2.16.jar
* bin/lib/aws-lambda-java-core-1.0.0.jar
* bin/lib/httpclient-4.3.4.jar
* bin/lib/org.apache.commons.io-2.4.jar
* bin/lib/commons-lang3-3.3.2.jar
* bin/lib/aws-java-sdk-s3-1.9.40.jar
* bin/lib/aws-java-sdk-core-1.9.40.jar
* bin/lib/commons-codec-1.9.jar
* bin/lib/aws-java-sdk-kms-1.9.40.jar
* bin/lib/aws-java-sdk-dynamodb-1.9.40.jar
* bin/lib/jaxb-api-2.3.0.jar
* bin/lib/commons-io-2.4.jar
* bin/lib/jetty-util-9.0.6.v20130930.jar
* bin/lib/httpcore-4.3.2.jar
* bin/lib/alexamodinput.jar
* bin/lib/istack-commons-runtime-3.0.10.jar
* bin/lib/jetty-http-9.0.6.v20130930.jar
* bin/lib/jackson-annotations-2.3.0.jar
* bin/lib/httpasyncclient-4.1.jar
* bin/lib/javax.servlet-3.0.0.v201112011016.jar
* bin/lib/httpcore-nio-4.4.1.jar
* bin/lib/jetty-server-9.0.6.v20130930.jar
* bin/lib/jaxb-core-2.3.0.1.jar
* bin/lib/httpasyncclient-cache-4.1.jar
* bin/lib/httpclient-cache-4.4.1.jar
* bin/lib/joda-time-2.9.1.jar
* bin/lib/httpcore-4.4.1.jar
* bin/lib/slf4j-api-1.7.10.jar
* dynamic_actions/lib/jsoup-1.8.3.jar
...
![alt text](../apps/alexa/skill_1.png)
...
![alt text](../apps/alexa/skill_2.png)
...
![alt text](../apps/alexa/skill_3.png)
...
![alt text](../apps/alexa/skill_4.png)
...
![alt text](../apps/alexa/skill_5.png) 
...
*  **global_auth_pass** : cleartext password. If you omit this , then the Alexa App will attempt to find an encrypted password that you can setup by navigating to the App's Setup page.
...
This App ships with an example dynamic action , [DocsLookupAction](../apps/alexa/DocsLookupAction.java) , that responds to an incoming intent request 
...
1. Create a class that extends the [DynamicAction](../apps/alexa/DynamicAction.java) base class.
2. Implement the `executeAction()` method , use the [DocsLookupAction](../apps/alexa/DocsLookupAction.java) example as a guide.You can access slot values and custom arguments 
...
Modular Input logs will get written to `$SPLUNK_HOME/var/log/splunk/alexamodinput_app_modularinput.log`

These logs are rotated after a max size of 5MB with a backup limit of 5.

Setup logs will get written to `$SPLUNK_HOME/var/log/splunk/alexamodinput_app_setuphandler.log`
