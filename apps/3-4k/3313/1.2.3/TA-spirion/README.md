...
Version 1.2.3 of the TA for Spirion is compatible with:
...
Version 1.2.3 of the TA for Spirion incorporates the following third-party software or libraries:
...
TA for Spirion supports the following server platforms in the versions support by Splunk Enterprise:
...
To function properly, TA for Spirion requires the following software:
...
Install the TA for Spirion on the single server using one of the methods described above. 

#### Deploy to distributed deployment

In a distributed deployment, the TA for Spirion should be installed on the following:
