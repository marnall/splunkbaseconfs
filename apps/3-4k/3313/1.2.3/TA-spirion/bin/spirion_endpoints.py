    ...
    def stream_events(self, inputs, ew):
        ...
        try:
            ...
            if dataset.status_code == 200:
                ...
                #Requesting Rows
                dataset=req.post(URL+'/Services/Data/LoadEndpoints',data=timestamp,verify=True)
                ...
                while (jsonData['data']!=[]):
                    ...
                    for spirion_event in jsonData['data']:
                        ...
                        event.host = URL + '/Services/Data/LoadEndpoints'
                ...
                dataset=req.post(URL+'/Services/Data/LoadEndpoints',data=timestampD,verify=True)
                jsonData = json.loads(dataset.content[5:])
                while (jsonData['data']!=[]):
            ...
            ew.log('ERROR','Splunk was unable to retrieve data from the Spirion API. The following error was encountered when accessing Spirion API Endpoint to obtain data: %s' %e)
