...
| inputlookup SSE-default-data-inventory-products.csv 
    ...
    | search NOT productId IN (MSSQL*, SQL*,MySQL*, Oracle*, Linux*, FireEye*, Fortinet*, Cylance*, Check*, Juniper*)
        """
        kwargs_normalsearch = {
            "exec_mode": "blocking",
            "count": 0,
...
def printOutput(data):
    ...
    for idx, result in enumerate(data):
        if idx == 0:
            writer.writerow(["macro", "definition", "_timediff", "eventtypeId", "productId", "source", "sourcetype", "total_rows"])
...
def checkForEdgeCases(data):
    ...
    for idx, x in enumerate(data):
        ...
        elif "o365_messagetrace" in str(x.get("macro", "")):
            x[filterSourceType] = "ms:o365:reporting:messagetrace|o365:reporting:messagetrace"
