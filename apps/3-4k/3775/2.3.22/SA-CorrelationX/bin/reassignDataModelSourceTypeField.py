...
def main():
	...
	reassignArray = json.loads(sys.argv[5].strip())
	...
	try:
		...
		output.writerow([
			json.dumps(service.reassignDataModelSourceTypeField(dataModelId, sourceTypeName, splunkSourceTypeName, reassignArray))
		])
