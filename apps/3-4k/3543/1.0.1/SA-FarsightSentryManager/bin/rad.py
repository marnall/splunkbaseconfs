...
SCHEME = """\
<scheme>
    <title>Sentry Manager RAD</title>
    <description>Pulls data from RAD module</description>
    <use_external_validation>true</use_external_validation>
    <streaming_mode>xml</streaming_mode>
    <endpoint>
        <args>
            <arg name="module">
                <title>RAD module</title>
                <description>Module documentation available here: [placeholder]</description>
            </arg>
            <arg name="watches">
                <title>Watches (comma delimited)</title>
            </arg>
            <arg name="options">
                <title>Options for selected module</title>
            </arg>
            <arg name="timeout">
...
def make_error_message(s, sessionKey, uri):
    ...
    r = requests.post(uri, headers=headers, data={'name':'Farsight RAD Input','value':s,'severity':'error'})
    r.raise_for_status()
...
def run():
    ...
    #Encrypted storage on hold till splunk can get it working.
    ...
    try:
        ...
        logging.error("Caught AXAMD Manager exception: %s" % (str(e)))
