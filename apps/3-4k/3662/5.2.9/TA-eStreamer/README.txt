...
Management Center’s eStreamer API server and convert and write that data into
Splunk Enterprise.  	
...
Questions and comments can be sent to encore-community@cisco.com# Binary File Declaration
