...
A lightweight dashboard to monitor feed status and configuration.
...
🌙 Dark‑Theme Friendly Icon: Custom app logo optimized for Splunk’s dark UI.
...
Appropriate index (ti_feeds) created and accessible.# Binary File Declaration
