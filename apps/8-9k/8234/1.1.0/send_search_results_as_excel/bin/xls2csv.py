...
def csv_from_excel(excel_file,csv_file,sheetnr):
    ...
    #for worksheet_name in all_worksheets:
        ...
        #your_csv_file = open(''.join([os.environ['SPLUNK_HOME'] + "/var/run/splunk/",worksheet_name,'.csv']), 'wb')
...
if __name__ == "__main__":
    csv_from_excel(os.environ['SPLUNK_HOME'] + "/var/run/splunk/" + sys.argv[1], os.environ['SPLUNK_HOME'] + "/var/run/splunk/" + sys.argv[3], sys.argv[2])
