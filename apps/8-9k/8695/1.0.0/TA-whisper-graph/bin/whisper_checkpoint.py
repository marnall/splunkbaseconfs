...
Replaces duplicated implementations across whisper_baseline_input,
...
def save_checkpoint(
    ...
    Args:
        ...
        input_name: Input stanza name (e.g. "whisper_baseline://default").
        data: Dictionary of checkpoint data to persist.
        prefix: File prefix for namespacing (e.g. "whisper_baseline").
    """
