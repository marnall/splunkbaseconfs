    ...
    def stream_events(self, inputs: smi.InputDefinition, ew: smi.EventWriter):
        ...
        for input_name, input_item in inputs.inputs.items():
            try:
                ...
                # Collect compliance data (SPF + DNSSEC) for each domain
                spf_events = []
                dnssec_events = []
                ...
                summary_stats = {
                    **stats,
                    ...
                    "dnssec_domains_checked": len(dnssec_events),
                }
                summary = smi.Event(
                ...
                ew.log(
                    "INFO",
                    "action=baseline input=%s records=%d spf=%d dnssec=%d domains=%d elapsed_s=%.1f"
                    % (
                        input_name,
