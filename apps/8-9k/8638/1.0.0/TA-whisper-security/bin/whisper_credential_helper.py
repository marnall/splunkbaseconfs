...
REALM_PREFIX = "__REST_CREDENTIAL__#TA-whisper-security#configs/conf-ta_whisper_security_account"
APP_NAME = "TA-whisper-security"
CONF_NAME = "ta_whisper_security_account"
...
def get_api_key(service: client.Service, account_name: str = "default") -> str | None:
    ...
    try:
        response = service.get(
            "/servicesNS/nobody/TA-whisper-security/storage/passwords",
            output_mode="json",
            count=0,
            search="TA-whisper-security",
        )
