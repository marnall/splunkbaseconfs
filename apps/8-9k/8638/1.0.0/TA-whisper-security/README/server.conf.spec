...
conf_replication_include.analyticstories = <bool>
* Whether to replicate analyticstories.conf across SHC members.
* Default: true

conf_replication_include.ta_whisper_security_settings = <bool>
* Whether to replicate ta_whisper_security_settings.conf across SHC members.
* Default: true

conf_replication_include.ta_whisper_security_account = <bool>
* Whether to replicate ta_whisper_security_account.conf across SHC members.
* Default: true
