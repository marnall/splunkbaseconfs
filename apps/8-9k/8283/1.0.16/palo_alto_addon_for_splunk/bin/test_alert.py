...
from palo_alto_addon_for_splunk import modalert_test_alert_helper
...
if __name__ == "__main__":
    exitcode = AlertActionWorkertest_alert("palo_alto_addon_for_splunk", "test_alert").run(sys.argv)
    sys.exit(exitcode)
