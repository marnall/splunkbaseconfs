...
`TA-anchore-add-on-for-splunk` project.
...
The `TA-anchore-add-on-for-splunk` maintainers take all security issues in the project
seriously. Thank you for improving the security of `TA-anchore-add-on-for-splunk`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`TA-anchore-add-on-for-splunk` leverages GitHub's private vulnerability reporting.
