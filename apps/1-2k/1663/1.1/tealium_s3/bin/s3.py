...
SCHEME = """<scheme>
    <title>Tealium S3 Connector</title>
    <description>Get Tealium Event Store data from Amazon S3.</description>
    ...
    <endpoint>
        <args>
            <arg name="name">
                <title>Tealium Event Store S3 Resource </title>
                <description>An S3 resource name without the leading s3://.  For example, for s3://uconnect.tealiumiq.com/customer/</description>
            </arg>

            <arg name="key_id">
                <title>Key ID</title>
                <description>Your Amazon Key ID (provided by your Tealium account manager)</description>
            </arg>

            <arg name="secret_key">
                <title>Secret key</title>
                <description>Your Amazon Secret key (provided by your Tealium account manager)</description>
            </arg>
        </args>
    </endpoint>
</scheme>
