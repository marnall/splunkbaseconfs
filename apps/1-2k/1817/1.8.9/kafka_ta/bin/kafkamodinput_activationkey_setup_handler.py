    ...
    def handleEdit(self, confInfo):
        ...
        try:
            ...
            try:
                ...
                for i, c in entities.items():
                    if c['eai:acl']['app'] ==  "kafka_ta":
                        username = c['username']
                        if username == "activation_key":
                            entity.deleteEntity(['storage', 'passwords'],":activation_key:",namespace="kafka_ta", owner='nobody', sessionKey=self.getSessionKey())           
            except:  
                e = sys.exc_info()[0]  
            ...
            try:
                ...
                new_credential = entity.Entity(['storage', 'passwords'], "activation_key", contents={'password':activation_key}, namespace="kafka_ta",owner='nobody')
