...
def run_java(config_xml=None):
    ...
    java_args = [ JAVA_EXECUTABLE, "-classpath",CLASSPATH,"-Xms128m","-Xmx256m","-Dsplunk.securetransport.protocol="+SECURE_TRANSPORT,"-DSPLUNK_HOME="+SPLUNK_HOME,"-DSPLUNKD_TIMEOUT_SECS="+SPLUNKD_TIMEOUT_SECS,JAVA_MAIN_CLASS]
