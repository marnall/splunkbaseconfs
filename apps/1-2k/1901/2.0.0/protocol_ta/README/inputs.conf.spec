...
* EXAMPLES
* handler_config = {encrypted:somekey}

# You require an activation key to use this App. Visit http://www.baboonbones.com/#activation  to obtain a non-expiring key
activation_key = <value>

* Modular Input script python logging level for messages written to $SPLUNK_HOME/var/log/splunk/protocolmodinput_app_modularinput.log , defaults to 'INFO'
log_level= <value>
...
*defaults to 1 , refer to http://vertx.io/vertx2/core_manual_java.html#specifying-number-of-instances
