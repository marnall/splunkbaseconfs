...
import modalert_stop_smbv1_service_helper

class AlertActionWorkerstop_smbv1_service(ModularAlertBase):

    def __init__(self, ta_name, alert_name):
        super(AlertActionWorkerstop_smbv1_service, self).__init__(ta_name, alert_name)
    ...
    def process_event(self, *args, **kwargs):
        ...
        try:
            ...
            if not self.validate_params():
                return 3 
            status = modalert_stop_smbv1_service_helper.process_event(self, *args, **kwargs)
...
if __name__ == "__main__":
    exitcode = AlertActionWorkerstop_smbv1_service("TA-ziften", "stop_smbv1_service").run(sys.argv)
    sys.exit(exitcode)
